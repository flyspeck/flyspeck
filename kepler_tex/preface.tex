...
highest possible density.   This assertion has become known as the Kepler conjecture. 
In 1836 Gauss established a special case of  the conjecture, when he proved that
the cannonball arrangement is optimal among all \newterm{lattices}~\cite{XX}.  Later
in the nineteenth century, Thue solved the corresponding problem in two dimensions, showing that
the hexagonal arrangements of disks in the plane achieves optimal density.   In 1900,
Hilbert, in his famous list of mathematical problems,  made this conjecture part of his eighteenth problem. 
In 1953, L. Fejes T\'oth formulated a general strategy to establish the Kepler conjecture, but lacked the computational
resources to carry it out.   The conjecture was finally resolved in 1998~\cite{XX}.  This
book presents a proof.
...
proofs. Russell's paradox and other antinomies threatened
...
constructed.  My decisions about what to include in this book have been
shaped by the list of theorems already available in the library of the
proof assistant {\tt HOL Light}.  For example, this book accepts basic
...
ones.  It much easier to formalize large number of short snappy proofs
...
several years.  These simplifications are published here for the first time.
G. Gonthier, who expresses his formal proof of the four-color
theorem in terms of hypermaps,   reworks the proofs of the
...
proof.~\cite{XX}''  C. Marchal has recently found a simple 
