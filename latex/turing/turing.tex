...
group\footnote{For decades, $E_8$ has stood for the ultimate in
  ...
  real world, when neutron scattering experiments with a cobalt
  niobate magnet were found to agree with $E_8$
  calculations~\cite{BGE8}.} of highest dimension is $E_8$.
...
In this approach, the determinant and permanent of a matrix are the paradigms of
what is easy and hard to compute, because they have a rich algebro-geometric
structure~\cite{Mul11}.
...
proof of the best known packing of regular tetrahedra in three dimensions~\cite{Chen-2010}; and the
