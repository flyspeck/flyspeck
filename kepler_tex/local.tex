...
the configuration exists with $\v_3\in C\{\v_1,\v_2\}$.
%, and in the
%more general setting where the constraint $2\le \norm{\v_1}{\v_2}$ is
%dropped.  
The point $\v_3$ can be moved in circular arcs centered at
$\v_1$ or $\v_2$ until $\norm{\v_2}{\v_3}=\norm{\v_1}{\v_3}=2$.  
(By the triangle inequality, this
constraint is met before any three points become collinear.)
The proof then
...
\norm{\v_1}{\v_2}= \norm{\v_1}{\v_4}=\norm{\v_3}{\v_2}=\norm{\v_3}{\v_4}=2.
\]
A \cc{3611774025}{A Cayley-Menger determinant is negative.} 
