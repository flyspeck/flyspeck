...
marking the endpoints of the interval.  The net result is an interval
that reliably contains the result of a real-number calculation.
...
Later in 1947, within minutes\footnote{My editor underlined
  ...
  Danztig described his first meeting with von Neumann in these
...
as the rolling hills in the countryside with cows grazing in the background.  
A helicopter
...
The width of the box is measured and found to be negative.
 The box is empty and contains no counterexamples. Hence, the
