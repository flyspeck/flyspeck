...
\def\svninfo{Version -- Jan 12, 2008  LOCAL:SVN:80}
\usepackage{graphicx}
\usepackage{verbatim}
\usepackage{latexsym}
\usepackage{amsfonts}
...
\begin{document}
    ...
    \title{Flyspeck :
      %\\ \phantom{Hello}
      \\ The Blueprint of the Formal Proof of the Kepler Conjecture}
...
for formalization.  This includes Trig (Chapter 1), Volume Calculations (Chapter 2), Hypermap (Chapter 3), Hypermap and Geometry : Topology of Fans (Chapter 4.1), Top-Level Structure (Chapter 5), Elementary Theory of the Reals (Chapter 16).
