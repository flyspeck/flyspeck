...
\begin{proof}
  ...
  is one of the most delicate computer estimates in the book.  Without the
  small correction term $\beta$, the inequality is false.  The
...
\begin{example}
%% XX example with and without beta term.
\end{example}
...
follows from an easy \cc{}{calc:cc:disks,  cc:disks, Marchal disks are disjoint.}
that
...
\] 
By a \cc{}{1965189142, cc:alin, Linear lower bound on regular polygon,
...
bounded.  By a \cc{}{8055810915: not typed in}
...
By a \cc{}{6096597438, cc:alin2, Linear lower bound on regular polygon (large disk),
