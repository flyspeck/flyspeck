...
\begin{lemma}\guid{GRUTOTI}
  ...
  satisfy $\norm{\u_0}{\u_1}<2\sqrt2$.  Set $\ee=\{\u_0,\u_1\}$.  Then
\[
...
%Marchal's conjecture~\ref{conj:m1} is still open.  
This section introduces a variant of Marchal's
...
$\leftclosed2,2.52\rightclosed$.  By contrast, Marchal's function is
