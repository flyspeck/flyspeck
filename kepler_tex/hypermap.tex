...
$S$-\newterm{flag} on $H$ is a boolean function on the set of faces that satisfies
...
Starting from from one marked hypermap $(H,{\cal L},L,x,\varphi)$, we construct a new marked hypermap $(H,{\cal M},L_1,x,\varphi')$
