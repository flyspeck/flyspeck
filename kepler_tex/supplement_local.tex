...
\begin{lemma}[482 obtuse]\guid{CUXVZOZ}\label{lemma:482-obtuse}
...
\begin{lemma}[482 obtuse bis]\guid{CJBDXXN}\label{lemma:482-obtuse-bis}
Let $s$ be a basic SCS, and let $p\in I(s)$.  Let $\v\in \MM_s$ be generic.
Assume that for all diagonals except $\{p-1,p+1\}$,
we have $a_{i,j}(s)<\norm{\v_i}{\v_j}$.  
Assume $3 \le \norm{\v_{p-1}}{\v_{p+1}}$.
...
\begin{lemma}[684 str]\guid{JOTSWIX}\label{lemma:684 str}
Let $s$ be a basic SCS, and let $p\in I(s)$.  Let $\v\in \MM_s$ be generic.
...
\begin{lemma}[1834 str]\guid{XESRYXG}\label{lemma:1834 str}
Let $s$ be a basic SCS, and let $p\in I(s)$.  Let $\v\in \MM_s$ be generic.
Assume that for all diagonals except $\{p-1,p+2\}$,
...
By a \cc{2485876245a}{}, $\v_1$ and $\v_3$ are not straight.  Another \cc{2125338128}{} gives that $\v_0$ and $\v_2$
are not straight.
