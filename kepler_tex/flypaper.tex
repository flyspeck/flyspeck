...
\def\verbose{f}  % put debugging info into text
...
%%  \label{part:intro}
   ...
   \input{preface} %proofed
   
   \chapter{Essays on Packings}
   \input{historical} %proofed
   \input{lectures}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \input{reduction} % 4/5/2008
    \chapter{Appendix: Assembly Listing}
    \input{assembly} % 4/5/2008
