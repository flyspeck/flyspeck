...
would have to create a formal ontology first (which is possible inside SWiM, though, or by
importing an external file), and then one would be able to annotate documents using terms
from that ontology.
