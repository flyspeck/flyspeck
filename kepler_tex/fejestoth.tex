...
Let 
$$
a = \| v(\lam_0,\lam_1) - \lam_0\|,\quad
b = \| v(\lam_0,\lam_1,\lam_2) - \lam_0\|,\quad
c = \| v(\lam_0,\lam_1,\lam_2,\lam_3) - \lam_0\|.\quad
$$
...
If any edge $\|\lam_i-\lam_j\|$ is greater than $2.52$, then
...
$$
Let $\lam' = (\lam_0,\lam2,\lam_1,\lam_3)$.
Define the $D_3$-cell to be
$$
(R_1(\lam) \cup R_1(\lam'))\cap B.
$$
(The condition $b< 1.26$ implies the constraint $\|\lam_i-\lam_j\|< 2.62$, for $i,j\in\{0,1,2\}$.)
...
volume of the intersection of the convex hull of $S$ with set of points closer to $\lam_0$ than to any other point in $S$.  When $\|\lam_0-\lam_i\| = 2$ and $\|\lam_i-\lam_j\| = y$ for $i,j\ge 1$, this volume depends
...
Thus, the strong dodecahedral conjecture follows from the same kissing number estimate that is used to prove the Kepler conjecture.
