...
The aim in this section is to prove that every restricted hypermap with a given bound
...
In heuristic terms, it takes only a finite number of pen strokes to retrace the pencil
...
% $x' = [\ldots;x]$ and let $L$ be the  canonically false contour loop of ${\cal L}$ that
...
subset of $\Omega$ such that $d$ is the maximum cardinality of a face.  A
...
% subquotient hypermap is a polygon $\op{Dih}_{2d}$.  When the  initial
