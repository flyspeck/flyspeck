...
Thisi section gives further detail to the argument of \cite[p131,Sec.12.7]{Hales:DCG:2006}.  There it is claimed that
the proof of the main estimate \cite[Theorem~12.1]{Hales:DCG:2006} can be reduced to polygonal standard regions.
...
the proof of the dodecahedral conjecture.\cite{DodXX}.}  We show that there is always an intervening loop
...
\begin{theorem}  If $\Gamma$ is not biconnected, then a nontrivial deformation exists in this context. 
...
\dih(y,y_2,2,2,2,y_3)+\dih(y,2.51,2.51,2,2,2.7)+\dih(y,y_4,2.51,2,2.7,y_5) >\pi.
$$
XX
...
Next we show that we cannot have two such edges $\{u_1,u_2\}$ and $\{u_1',u_2'\}$ with non-distinct endpoints
under certain edge constraints.
