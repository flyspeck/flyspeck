...
\begin{lemma}\guid{TXFBALB}\rating{ZZ}  The area conclusion (Lemma~\ref{lemma:face}.iii) holds for every minimal counterexample $(V,E)$.
\end{lemma}
...
\begin{lemma}\guid{GGZWYRM}\rating{ZZ}  Let $(V,E)$ be a minimal counterexample.  For any dart $x$ on the face $F$ and dart $y\in F$ that is not adjacent to $x$ under the face map, 
$$
