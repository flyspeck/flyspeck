...
will use background facts in these areas wherever they help.
...
definition 
\begin{eqnarray}\label{eqn:cospi2}
\cos(\pi/2) &=& 0,\nonumber\\
...
inverse trigonometric functions will generally be reduced to the
...
cosines, and a beautiful formula that Euler and Lagrange gave for the area of a
spherical triangle.
