...
\begin{lemma}  Suppose $G(\Lambda)$ contains three vertices,
...
$$
\op{aff}_+(0,\{v_1,v_2,v_3\}) \cap \Omega(\Lambda,0) = 
\op{aff}_+(0,\{v_1,v_2,v_3\}) \cap \Omega_{trunc}(\Lambda,0) = 
...
Furthermore, suppose now that there is some face of the graph that
is not simple.
