...
and reverified there. XX XX cite.
...
project is the full formal verification an operating system kernel~\cite{sel4}.  In this survey article,
...
References: \cite{CakeML}, \cite{myreen2013steps}, \cite{myreen2013proof}, \cite{sarkar2009semantics}.
...
Because of the influence of the Feit-Thompson theorem within the classification, 
this formalization project plants a flag in the middle of the larger classification project.
...
(Cite XX).
In the Isabelle/HOL proof assistant~\cite{bohme2010sledgehammer}, 
depending on the library....  In the Mizar proof assistant~\cite{urban2010evaluation}, the sledgehammer
works X\%.  In the HOL Light proof assistant, XX \cite{kaliszyk2012learning}, \cite{kaliszyk2013automated}.
...
culture with many success stories; let's move to data driven theorem proving.}
...
Urban and Kalizyk have developed machine-learning methods for premise-selection~\cite{alama2014premise}.
...
into a computer readable form with semantic content.  \cite{ganesalingam2013language}.
...
Formalization rates for mathematics as a whole remain distant but eventually attainable.
