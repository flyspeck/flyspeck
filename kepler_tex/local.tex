...
\begin{lemma}[quadrilateral~free]\guid{JNTEFVP}\rating{250}\label{lemma:quadrilateral-free}\label{l:qf}
...
\begin{lemma}[pentagon~free]\guid{PQFYWHW}\rating{250}\label{lemma:pentagon-free}\label{l:pf}
...
\begin{lemma}[hexagon~free]\guid{GYQVFXJ}\rating{200}\label{lemma:hexagon-free}\label{l:hf}
