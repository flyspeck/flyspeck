...
\begin{theorem}\guid{KIZHLTL}\label{theorem:mk1} 
...
three terms $T_i = T_i(r)$ of \eqref{eqn:gamma-def}.  The desired
equation~\eqref{eqn:neg} consists of three corresponding terms
...
directly from equation~\eqref{eqn:km} and Assertion~\ref{conj:L12}.
...
\[ \gamma(X,L)\ge 0\]  
by Lemma~\ref{lemma:LI}.  %\cc{TSKAJXY}{}. %by inequality \eqref{eqn:mfe}.
