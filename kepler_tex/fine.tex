...
standard pre-planar graph $(v_0,V,E)$ and hypermap $H$.  For
...
obtained from a pre-planar graph (obtained by deleting edges and
vertices from the standard pre-planar graph).
