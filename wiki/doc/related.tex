...
wikis\footnote{See \url{http://homepages.inf.ed.ac.uk/da/mathwiki/} for relevant
  activities.}.  \product{Logiweb} and \product{ProofWiki} are wiki-like systems
...
if the central maintainer approach does not turn out to work.\ednote{@Christoph:
  Find out whether such systems have already been used in Flyspeck-like
