...
\begin{tidbit}
  ...
  definition of angle.  My teacher insisted that a mathematician is
  under no obligation to justify a definition.  Mathematical
  consistency suffices.  I wanted more: does the definition conform to
  ...
  definition in the plane.  Of course, that is precisely what this definition
  accomplishes.  The norm (Definition~\ref{def:norm}) also conforms to
