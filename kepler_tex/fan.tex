...
A fan $(V,E)$ is {\it fully surrounded}, if $\op{azim}(x)<\pi$ for all darts $x$ in the
hypermap of $(V,E)$.
\end{definition}
...
Let $(V,E)$  be a fan with hypermap $(D,e,n,f)$.    The fan is {\it conforming} if the
...
A fan $(V,E)$ is said to be {\it minimally non conforming} if the following conditions hold.
\begin{itemize}
