...
%% (skipped) weakness in sharing between systems.
%  add Gonthier's odd order (see 2/3 papers TPHOLs), Thompson spelling.
%  (skipped) SML type safefy formalization after Leroy,  http://portal.acm.org/citation.cfm?id=1190215.1190245 
% add many citations.
% loses focus towards the end.
% E:check Leroy credit.
% state purpose and audience better. Purpose to state current progress,
%   but digresses into flyspeck, conjecturing, etc.
% goes general to specific, then general again in 7,8,9. Need better transition.
%  I: whose notion of infinite is it that gives a fn that is injective not surj.
...
\author{Thomas C. Hales\thanks{The author's research on the Formal Foundations of Discrete Geometry has been supported by NSF grant 0503447.  He thanks Mark Adams, K. Parkinson, and F. Wiedijk for comments.}}
...
Computer proof assistants have been under development for decades (see Box~\ref{XX}), 
but only recently
...
%
%Although these systems currently take considerable effort to learn,  
The hope
...
from the use of the letter $\lambda$ to mark function arguments.  Box~\ref{XX} lays out
...
%
The system has ten rules of inference, as described in Box~\ref{XX}.
...
curried function % of type $\tc bool\to bool\to bool$
...
%An exegesis of AM appears in~\cite{Haase}.
...
%\bibitem{ACL2} ACL2 Version 3.4, http://www.cs.utexas.edu/users/moore/acl2/.
...
%Selected Papers on Automath, edited by R.P. Nederpelt, J.H. Geuvers
%and R.C. de Vrijer, Studies in Logic, vol. 133, pp. 201-228. North-Holland 1994.
...
%\bibitem{Meta} MetaPRL Proof Assistant and Logical Programming Environment, http://metaprl.org/default.html.
...
%\bibitem{PRL} PRL Automated Reasoning Project at Cornell, http://www.cs.cornell.edu/Info/Projects/NuPRL/nuprl.html.

\bibitem{PW} ProofWeb, http://prover.cs.ru.nl/login.php.

%\bibitem{PVS} PVS Specification and Verification System, http://pvs.csl.sri.com/.
