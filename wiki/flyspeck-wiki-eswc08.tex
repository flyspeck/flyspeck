...
the project must be given, as well as tools for browsing and querying the knowledge.

While a small group of maintainers will integrate submitted formal
proofs into one central proof script, metadata \emph{about} the progress of the proof 
...
In a later phase\ednote{@CL: Do the proof in the wiki}
