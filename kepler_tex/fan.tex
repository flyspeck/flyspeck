...
\begin{definition}[affine~set,~affine~hull,~affine~dimension,~affinely~independent]\label{def:affine}
...
We will assume as background knowledge various basic facts about affine sets.
