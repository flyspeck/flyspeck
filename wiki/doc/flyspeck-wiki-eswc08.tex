...
\begin{abstract}
  ...
  thereon.  We are now evaluating these technologies in concrete application scenarios.
  ...
  knowledge management by focusing on \textit{the Flyspeck project}\ednote{@Sean, there
    was a leftover \verb|\cite{Flyspeck:definition}|, which I'd like to move somewhere
