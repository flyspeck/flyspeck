...
distinguished vertex $v$:
    $$
    \begin{array}{lll}
    &2\Gamma(Q) + \op{sovo}_0(v,Q,\lambda_{oct}) - \op{sovo}_0(\hat v,Q,\lambda_{oct}) \le 0\\
    &\op{sovolan}(v,Q,\lambda_{oct}) + \op{sovolan}(\hat v,Q,\lambda_{oct}) 
  +\op{sovo}_0(v,Q,\lambda_{oct}) - \op{sovo}_0(\hat v,Q,\lambda_{oct})\le0.
    \end{array}
    $$
