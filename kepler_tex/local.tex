...
\begin{lemma}[]\guid{WRGCVDR}\rating{300}  
...
\begin{lemma}[localization]\guid{LVDUCXU}\rating{450}
...
\begin{lemma}[trichotomy]\guid{CIZMRRH}\rating{200} %
...
\begin{lemma}[]\guid{LDURDPN}\rating{100}  \label{lemma:coplanar}
...
The following lemma is peculiar in that it
