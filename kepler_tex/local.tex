...
$\tau_{min}=0$.  Any special fan $(V,E,F,G)$ with parameter
...
E\setminus G$ of the minimal fan $(V,E,F,G)$ is not extremal.  
...
showing that every minimal fan is irreducible at each of its vertices.
