...
\index{Kepler conjecture} sphere packing problem.
\index{sphere packing problem}
...
meaning of the sphere packing problem is to show that for every %saturated 
packing
...
sphere packing problem follows if for each %saturated 
packing $\Lambda$ we
