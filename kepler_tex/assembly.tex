...
Now assume that $|v-v_0|\le 2.696$. If the simplices $\{0,v,v_1,v_3\}$
...
that $(\Lambda,v)$ determines a set $U(\Lambda,v)$ of vertices in Euclidean
...
A centered packing $(\Lambda,v)$ determines a set of vertices $U(\Lambda,v)$ that
...
corners $v_1$, $v_2$, and $v_3$, respectively in $U(\Lambda,v)$. By
...
$2t_0$ from the five corners of $U(\Lambda,v)$ over the pentagon.}
