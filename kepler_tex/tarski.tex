...
\def\tlabel{\label}
\newenvironment{tarski}{\clearpage%
\def\name   {\marker{Name}}
...
\marker{condC, condF, condS, ball, anchor, rcone, collinear, bis, rad, eta, beta, epsilon, arc, anchor, rogers}{A term with the same name appears.}
...
\begin{lemma}\tlabel{tarski:sqrt2-chi+}\usage{DCG-[5.18]{lemma:sqrt2-chi+}}
%
