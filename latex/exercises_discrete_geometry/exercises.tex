...
in the interval $[\sqrt8,3.27]$ is at least 
\[
\pi/2 > \sol_0 + d_3 = \sol_0 + 3 (0.27).
\]
The other cases are similar.

In the case $(r,s,t)=(1,1,1)$, there is an edge length in the interval $\leftclosed 2 h_0,\sqrt8\rightopen$.
