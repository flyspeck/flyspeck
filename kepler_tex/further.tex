...
The Sch\"utte-van der Waerden arrangement
% is formed by one point at the north
...
%equally spaced on further circles of constant latitude 
%The arrangement 
is obtained by placing balls at the centers of the twelve
edges of a cube, then deforming the cube so that there is room for a thirteenth
sphere near the center of one of its faces (Figure~\ref{fig:svdw}).
