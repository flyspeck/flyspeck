...
proofs in this book.  The pronoun \fullterm{I}{I (use of personal
  pronoun)} refers to the author alone, as in the first sentence of
...
\index{Notation}{4@$\wild$ (wildcard symbol)}
...
\index{Notation}{5@$\bigcup$ (big union operator)}
\index{Notation}{5@$\bigcap$ (big intersection operator)}
