...
Then 
\begin{description}
\item[(circumcenter)]  $\omega(\trunc{\bu}{j})$ is the circumcenter of the
set $S_j =\{ \u_0,\ldots, \u_j\}$.
\item[(convex hull)]  The circumcenter of $S_j$ lies in the convex
hull of $S_j$.
...
\claim{The point $\p$ lies in $\Omega(V,S_{j})$.}   Otherwise
