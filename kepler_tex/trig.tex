...
\end{equation}
\mar{\guid{YTXXLRB}Eq.~\hyperref[lemma:tan-pi4]}
...
\begin{definition}[arccos]\guid{QZTBJMH}\label{def:arccos}\formal{acs,\ ACS\_COS,\ COS\_ACS}
  By the inverse function theorem of \hyperref[back:analysis]{real
...
\begin{definition}[dot product]\guid{VFPCZBI}\label{def:dot}
There is a \newterm{dot product}
\begin{displaymath}
...
\begin{definition}[norm]\guid{XHVXJVB}\label{def:norm}
