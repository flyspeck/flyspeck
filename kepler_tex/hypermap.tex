...
\claim{$L'$ is false.}   Otherwise, $L'$ is true with respect to the canonical flag and it therefore
...
\begin{definition}[transform]
  ...
  $T(H,{\cal{L}},L,x,\varphi)$, called the \newterm{transform} of
...
\case{node-free} The set of darts of $L_1$ and $L_2$ at the nodes of $u\not\in
\{f y,\ldots,f^p y\}$
...
\case{flag-1} \claim{The true faces of $H''$ (with respect to $\varphi'$) are
  connected.}  Indeed, if $L_2$ is false, then the set of true faces
