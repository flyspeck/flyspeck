...
Interval analysis is a method of obtaining trustworthy computations over
the real numbers from a computer.  This subsection gives a basic
introduction to this method.  Details may be found in standard textbooks~\cite{unknown}.
% Kearfott, Moore, etc.
