...
\begin{definition}[saturated,~packing]\guid{CODE}
...
\begin{definition}[Voronoi~cell,~$\Omega$]\guid{CODE}\label{def:voronoi}
...
\begin{lemma}[]\guid{CODE}\label{lemma:V4}
...
\begin{definition}[$\Omega$ reprise]\guid{CODE}
...
\begin{lemma}[]\guid{CODE}\label{lemma:omega-face}  
...
\begin{lemma}[]\guid{CODE}\label{lemma:omega-facet} 
...
\begin{definition}[$\omega$]\guid{CODE}
...
\begin{definition}[R,~Rogers simplex]\guid{CODE}
...
\begin{definition}[circumcenter,~circumradius]\guid{CODE}
...
\begin{lemma}[]\guid{CODE}\label{lemma:affine-system}
...
\begin{lemma}[]\guid{CODE}\label{lemma:affhull-center}
...
\begin{lemma}[]\guid{CODE}\rating{400}\label{lemma:sqrt2-close}
...
\begin{lemma}[]\guid{CODE}\label{lemma:coset-bijection}
...
\begin{definition}[Marchal cells]\guid{CODE} 
Let $V$ be a saturated packing.  
...
\begin{definition}[$i$-rearrangement]\guid{CODE}
...
\begin{lemma}[]\guid{CODE}\label{lemma:M-complement4}
...
\begin{lemma}[]\guid{CODE}\label{lemma:M-exhaust}
...
\begin{definition}[negligible,~fcc-compatible]\guid{CODE}\label{def:negligible}
...
\begin{definition}[$\sol_0$,~$\tau_0$,~$m_1$,~$m_2$,~$h_+$,~$M$]\guid{CODE}
...
\begin{definition}[$V(X)$,~$\op{tsol}$]\guid{CODE}
...
\begin{definition}[$\dih(X,e)$,~$h$]\guid{CODE}
...
\begin{definition}[$\gamma$]\guid{CODE}
...
\begin{theorem}[Marchal's inequality]\guid{CODE}
...
\begin{definition}[$L$,~$h_0$,~$h_-$]\guid{CODE}\label{def:L}
Set
\begin{displaymath}
h_0 = 1.26\\  %%\hm
\end{displaymath}
...
\begin{definition}[critical edge,~$\op{EC}$,~$\op{wt}$]\guid{CODE}\label{def:wt}
...
\begin{definition}[$\beta$,~$\op{bump}$]\guid{CODE}\label{def:beta}
Set 
\begin{displaymath}
...
\begin{definition}[cell cluster,~$\Gamma$,~$\gamma_L$]\guid{CODE}\label{def:gammaL}
...
\begin{definition}[weakly saturated]\guid{CODE}
