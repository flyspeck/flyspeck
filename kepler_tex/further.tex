...
The circle is centered on the bisector of $\u$ and $\v$, and the endpoints
of the arc are the antipodes of $\u$ and $\v$.
...
\begin{theorem}\guid{VGJDQJV}\label{lemma:main-estimate-12}
  ...
  of $\op{hyp}(V,E)$ such that $(V,E,F)$ is a local fan.  
   %Assume that
