...
\begin{proof} Let $H=(D,e,n,f)$ and let $H' =(D',e',n',f') = H/{\cal
...
\claim{$e'y'\not\in S'$, where  $y'$ is the image of $y$ in $H'$. }  Otherwise,
...
\case{flag-1} \claim{The true faces (with respect to $\varphi'$) are
