...
\ednote{To do: Change the title into something more appropriate, but it may still be
  lurid ;-)}
...
\begin{abstract}
  ...
  mathematical knowledge management in particular.  Building on the OMDoc semantic markup
