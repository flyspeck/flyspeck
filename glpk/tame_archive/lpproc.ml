...
(* external files. 
   graph_all.mod is the concatenation of head.mod, body.mod, tail.mod. 
   body.mod is automatically generated by Parse_ineq.lpstring *)

let archiveraw = "/tmp/tame_graph.txt";; (*read only *)
let model = "/tmp/graph_all.mod";; (* read only *)
...
let execute() = (* takes about 2.5 hours to run. Tested on 2010-06-24, svn 1847. *)
