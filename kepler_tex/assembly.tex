...
table entry $b(7,0)$ (Lemma~\ref{lemma:pq-types}). If $r\ge1$,
...
The enclosed vertex has zero, one, or two anchors\FIXX{Why not 3?}.  
The upright
...
at $v_1$.  By tarski\tarf{XX}, we cannot have both diagonals $\{v_1,v_3\}$ and $\{v_2,v_4\}$
...
more comments are needed for $Z(4,1)$.  Let $S$
...
In the context $(n,k)=(4,3)$, the standard component $R$ must have at
