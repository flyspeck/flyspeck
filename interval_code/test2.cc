...
void selfTest() { 
  ...
  epsValue("ups_126",Lib::ups_126,71.326400000000);
  epsValue("delta_126_x",delta_126_x(interval::interval("0.140000"),interval::interval("0.240000"),interval::interval("0.340000")),-105.771664000000);
  epsValue("delta_234_x",delta_234_x(interval::interval("0.140000"),interval::interval("0.240000"),interval::interval("0.340000")),-66.247800000000);
  epsValue("delta_135_x",delta_135_x(interval::interval("0.140000"),interval::interval("0.240000"),interval::interval("0.340000")),-105.982464000000);
  epsValue("delta_sub1_x",delta_sub1_x(interval::interval("0.140000")),7.518360000000);
  epsValue("taum_sub1_x",taum_sub1_x(interval::interval("0.140000")),0.122046676350);
  epsValue("gamma3f_x_div_sqrtdelta",gamma3f_x_div_sqrtdelta(interval::interval("0.140000"),interval::interval("0.240000"),interval::interval("0.340000")),-0.011756773994);
  epsValue("vol3f_456",vol3f_456(interval::interval("0.140000")),0.464530693116);
  epsValue("gamma3_x",gamma3_x(interval::interval("0.140000")),-0.005516047986);
  epsValue("gamma23_full8_x",gamma23_full8_x(interval::interval("0.140000")),0.055415723962);
  epsValue("gamma23_keep135_x",gamma23_keep135_x(interval::interval("0.140000")),0.033319887940);
  epsValue("mudLs_234_x",mudLs_234_x(interval::interval("0.140000"),interval::interval("0.240000"),interval::interval("0.340000"),interval::interval("0.440000"),interval::interval("0.540000")),-31.277036910818);
  epsValue("mudLs_126_x",mudLs_126_x(interval::interval("0.140000"),interval::interval("0.240000"),interval::interval("0.340000"),interval::interval("0.440000"),interval::interval("0.540000")),-48.325135995037);
  epsValue("mudLs_135_x",mudLs_135_x(interval::interval("0.140000"),interval::interval("0.240000"),interval::interval("0.340000"),interval::interval("0.440000"),interval::interval("0.540000")),-48.349169797523); 
       cout << " -- done loading test_auto test" << endl << flush; }


 const char svn[] = "svn(3385:3386,170M)";
