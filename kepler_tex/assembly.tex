...
\begin{lemma}\guid{QOSRQXP}\label{lemma:0.1317} If $R$ is a quad cluster, then
...
\begin{lemma}\guid{OOSQSIG} \label{lemma:pq-impossible}
    %\proclaim{Lemma 6.1}
...
\begin{lemma}\guid{DFYCADR}\label{lemma:ex-xtazimge}
...
\begin{lemma}\guid{QKTNODP}\label{lemma:ex-x31}
...
\begin{lemma}\guid{LGCYOUR}\label{a:context11} %\label{eqn:4.9}
...
\begin{lemma}\guid{GMXMAKL}\dcg{Lemma~11.2}{114}
    \oldlabel{3.4.1}
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
...
by Tarski arithmetic\tarf{eta245}, $\eta_{456}>\sqrt2$).
If $S$ is  not of type $\SC$, then by Tarski arithmetic\tarf{eta696}\tarf{eta-rad},
...
\begin{lemma}\guid{WPLIOPG}\dcg{Lemma~11.3}{115}
    \oldlabel{3.4.2}
...
\begin{lemma}\guid{HRJITPQ}\dcg{Lemma~11.4}{XX}\label{lemma:context6-erase}{115}  
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
...
\begin{lemma}\guid{HOGPDIL}\dcg{Sec~11.7,intro}{118}\label{a:5dart:concave}  
...
\begin{lemma}\guid{KGBJVWS}\dcg{Sec~11.7,Rem~11.3}{118}  An upright diagonal with
...
\begin{lemma}\guid{HKKCBHW}\label{a:5dart:3q}\dcg{Sec~11.7,in Lemma~11.14}{119}
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
...
\begin{lemma}\guid{VXUTGQM}\dcg{Lemma~11.14}{119}  Let $H$ be a geometric
...
\begin{lemma}\guid{KZWJTEV}\label{lemma:4-crowdedq}\dcg{Lemma~11.18}{119}
    %\oldlabel{3.8.3}
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
...
\begin{lemma}\guid{TPKMBYO}\dcg{Cor~11.9}{120}  
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
...
\begin{lemma}\guid{DRAIWSS} \label{a:min0-vor} 
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
...
By Tarski arithmetic\tarfE{E:part4:2}, we have $|v-v_0|>2.6$.
If $|v_1-v_2|\le 2.1$,  or $|v_1-v_3|\le 2.1$, then
Tarski arithmetic\tarfE{E:part4:3} gives $|v-v_0|>2.72$, 
...
\begin{lemma}\guid{IIBMEDL}\dcg{Remark~11.28}{125}
...
\begin{lemma}\guid{MFNHYHP}[Erasing four darts, no masked]
\dcg{Lemma~11.21}{120}
\oldlabel{3.9.1}
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
...
\begin{lemma}\guid{MNHOSWM}[Erasing four darts, masked]\dcg{After Rem~11.22}{120}
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
Let $N$ be a node
whose darts are upright.  Assume that $N$ has cardinality four.
...
\begin{lemma}\guid{TYGLGFR}\dcg{Lemma~11.23}{121}
    \oldlabel{3.9.2}
    \label{lemma:0.008}
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
...
\begin{lemma}\guid{RDPQSVF}\dcg{Lemma~11.23}{121}
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
Let
Let $N$ be a node that is an upright diagonal with four darts.  
...
By Tarski arithmetic\tarf{dcg-p122}, 
...
$\op{conv}\{v_0,v,v_2\}$.
To establish (1) assume that $|v_2-v_0|\ge 2.2$.  Tarski arithmetic\tarfE{last:E} 
gives
    $$|v_1-v_3|>2.6.$$
The bound $0.0063$ comes from
    $$\xikG + 2\xiV < -0.0063$$

To establish (2) assume that $|v_2-v_0|\le 2.2$. Tarski arithmetic\tarfE{last:E} gives
    $$|v_1-v_3|>2.7.$$
  If the simplex
...
\begin{lemma}\guid{TPHPSUI}\dcg{Lemma~11.29}{125}
    \oldlabel{3.11.3}
...
\begin{lemma}\guid{DGCSOAB}\dcg{Lemma~11.30}{125}\label{lemma:1.32}
    \oldlabel{3.11.4}
Let $(\Lambda,v_0)$ be a centered packing, 
with $(\Lambda,\CalQ(\Lambda,v_0))$-compatible fan $H$.
...
\begin{lemma}\guid{EAPKLYL}\label{a:6}\dcg{Lemma~21.4}{223} 
...
\begin{lemma}\guid{DYCEJMP} We have the following estimates:
    $$
    \begin{array}{lll}
...
\begin{lemma}\guid{FHVJCKT}  If $v$  is a node of an exceptional face,
...
\begin{lemma}\guid{YYBQALF}\label{a:311}  % Used in separation props of tame graphs.
...
\begin{lemma}\guid{SLPIELO}\label{a:no-ef}  Let $v$ be a node of type
...
\begin{lemma}\guid{RUHAFDS}\label{lemma:quarter0}\dcg{Lemma 8.12}
...
\begin{lemma}\guid{MGPMTMR}\dcg{Lemma~14.3}{158}  
...
\begin{proof} This is Tarski arithmetic\tarf{4circuit}.
\end{proof}
...
\begin{lemma}\guid{YXJLYKO}\dcg{Lemma~14.4}{159} \tlabel{lemma:11.16}
...
\begin{lemma}\guid{ZBBMOXX} \label{lemma:mixed-vor0}
...
% Rewritten.
\begin{lemma}\guid{XZNHIKM}\dcg{Lemma~10.14}{105}\tlabel{lemma:1.04}
...
by Tarski arithmetic\tarf{enclosed}. In particular, the anchors of an
enclosed vertex are corners of the quad cluster. There are no flat
quarters.  Both diagonals $\{v_1,v_3\}$, $\{v_2,v_4\}$ have length
at least $\sqrt8$.

% deprecated 4/4/2008
%We may assume that the height of each corner is at most $2.3$.
%This is seen as follows.  An upper bound on the mixed quad cluster
%is $\op{sv}_0(\Lambda,v_0,UC_)$ 
%by Lemma~\ref{lemma:mixed-vor0}.  If any height is at least
%$2.3$, then by a calculation\footnote{\newcalc{7710172071 (deprecated)}},
%% cfsqp blueprint.cc, 3/4/2008.
%% changed 2.38->2.3 to make consistent with 771017 on 4/4/2008.
...
%DCG Lemma 12.10 and Lemma 13.1 
...
Finally suppose that $|v_4-v_0| =2$.  A calculation\footnote{\newcalc{6479729349}} shows that $\azim(v_0,v,w_1,w_2) < \pi/2$, for $(w_1,w_2)=(v_3,v_4),\ (v_4,v_1)$.  The inequalities $|v_1-v_3|\ge \sqrt8$ and $2t_0\le |v-v_2|\le 3.17$
also hold.
The fitted crown, and two other
simplices combined\footnote{\newcalc{1741049647}} give less than $-1.04\,\pt$.
...
\begin{lemma}\guid{NTRAFQA}\dcg{Lemma~14.5}{160}\label{lemma:6079}  
...
be two flat quarters because then Tarski arithmetic\tarfE{E:part4:5} gives
$$|v_{12}-v_0|>2t_0.$$
...
$|v_{12}-v_5|<3.488$. Otherwise, setting $S=(v_{12},v_4,v_5,v_1)$, Tarski arithmetic\tarf{3488}
...
$\{v_0,v_1,v_2,v_5\}$ because this and Tarski arithmetic\tarfE{E:part4:6}\tarfE{E:part4:7} would lead to a contradiction
$y_{12}>2t_0$. 
...
quarters because then Tarski arithmetic\tarfE{E:part4:8}\tarfE{E:part4:9} would imply $|v_{12}-v_0|>2t_0$.
...
\begin{lemma}\guid{STYULLV}\tlabel{lemma:tcc-est} 
...
\begin{lemma}\guid{NTEOOVX}\label{lemma:CC815}  
...
\begin{lemma}\guid{AFTJICR}\label{lemma:slice-quarter}
...
\begin{lemma}\guid{PWAGYHV}\oldlabel{3.7.1}\label{lemma:3-crowded}
...
\begin{lemma}\guid{QKFOZDA}[deprecated]
    \oldlabel{3.7.2}
\FIXX{This is deprecated because it involves $\sqrt2$ truncation.}
...
Truncation at $\sqrt{2}$ is justified by Tarski arithmetic\tarf{old372}.
...
\begin{lemma}\guid{YOCZVRP}\dcg{Cor~11.25}{122}
...
\begin{proof}
This follows by Tarski arithmetic\tarf{dcg-p122}.
\end{proof}


\subsection{penalty constant}

\begin{definition}[$\xiG$,~$\xiV$,~$\xiG'$,~$\xik$,~$\xikG$]\indy{Greek}{zzxiG@$\xiG$}\indy{Greek}{zzxiV@$\xiV$}
...
\begin{lemma}\guid{OQONWUD}\label{lemma:min0-svor}
    \oldlabel{3.11.2}
...
$$
\indy{Index}{sovo}\indy{Greek}{ZZlambda@$\lambda$}
%\indy{Greek}{ZZlambdaoct@$\lambda_{oct}$}
\indy{Greek}{ZZlambdasq@$\lambda_{sq}$}


\begin{lemma}\guid{ZXXTZRH}\label{lemma:rog-squ0}
...
$2/\sqrt{3}\le b = \eta_V(v_0,v_1,v_2)$ (Tarski arithmetic\tarf{XX}),
...
\begin{lemma}\guid{OUODBMW}\label{lemma:phi-sq0}
...
\begin{lemma}\guid{PAGVJBH}\label{lemma:pl-sq0}
...
\begin{lemma}\guid{ENWTVFZ}\label{lemma:roger0}
    %proclaim{Lemma 3.1}
    %\oldlabel{part3.3.1}
...
\begin{proof}
    This fact is proved by Tarski arithmetic\tarfE{2t0-doesnt-pass-through}.
\end{proof}
...
\begin{lemma}\guid{FYLANXX} \label{lemma:wedge} Consider the wedge of a cone
    $$
    W =W(\alpha,z_0) =
...
wedge with $B(0,1)$. Then
    $$A\le\doct\,\op{vol}(W).$$
Equality is attained if and only if $W$ has zero volume.\indy{Index}{cone}
\end{lemma}
...
\begin{lemma}\guid{RVLXXZP} \label{lemma:cone}
...
\begin{lemma}\guid{JQRJIVJ}\label{lemma:pure0}
...
\end{theorem}\indy{Index}{cluster!quad}
...
\begin{lemma}\guid{PKNXGXX}  %=claim\label{claim-F}
...
\begin{proof}
This is Tarski arithmetic\tarf{anc-simplex-not-enc}.
\end{proof}
...
simplices.  By Tarski arithmetic\tarf{311}, if
...
\begin{lemma}\guid{ZDKGFOH}\label{lemma:loop}
...
Recall that $\epsilon_0 = 10^{-12}$.\indy{Greek}{ZZepsilon@$\epsilon_0$}
...
\begin{lemma}\guid{PYIWBQU}\tlabel{lemma:pentprism-aggregate}
...
\begin{lemma}\guid{IHMKLKJ}\tlabel{lemma:pentprism-lowtet}
...
\begin{lemma}\guid{SJWXZFC}\tlabel{lemma:pentprism-lowquad}
...
\begin{lemma}\guid{UYYHIUL}\tlabel{lemma:pentprism-lowcap}
Let $(\Lambda,v_0)$ be a pentahedral prism.  Suppose that for some 
...
\begin{lemma}\guid{IFEORDC}\tlabel{lemma:proper-pp-dih}\rating{20}
...
\begin{lemma}\guid{PARNHPY}\tlabel{lemma:pp-flat}\rating{50}
Let $(\Lambda,v_0)$ be a proper pentahedral prism.
...
\begin{lemma}\guid{WLDZRSL}\tlabel{lemma:pp-ht}\rating{50}
Let $(\Lambda,v_0)$ be a proper pentahedral prism.  
Let $(v_0,V,E) = (v_0,V_{std}(\CalQ),E_{std}(\CalQ)$ be the $Q$-system
extended fan.
Let $\CalF$ be the set
...
\begin{lemma}\guid{CJDXXGU}\tlabel{lemma:pp-oct}\rating{100}
Let $(\Lambda,v_0)$ be a proper pentahedral prism.
Let $(v_0,V,E) = (v_0,V_{std}(\CalQ),E_{std}(\CalQ)$ be the $Q$-system
extended fan.
Let $\CalF$ be the set
...
\begin{lemma}\guid{LGFEEVK}\tlabel{lemma:acute-pp}
Let $(\Lambda,v_0)$ be a proper pentahedral prism.
Let $(v_0,V,E) = (v_0,V_{std}(\CalQ),E_{std}(\CalQ)$ be the $Q$-system
extended fan.
Let $F$ be a face
...
\begin{proof}
Set $E' = E\cup \{v_1,v_2\}$.  By Tarski arithmetic\tarf{XX}, it follows
...
\begin{lemma}\guid{KMVOKWX}\tlabel{lemma:obtuse-pp}\rating{400}
Let $(\Lambda,v_0)$ be a proper pentahedral prism.
Let $(v_0,V,E) = (v_0,V_{std}(\CalQ),E_{std}(\CalQ)$ be the $Q$-system
extended fan.
Let $F$ be a face
...
\begin{lemma}\guid{EWLPZDR}\tlabel{lemma:pp-contravene}
...
\begin{lemma}\guid{XNUMOTT} If $\optt{upright}(\alpha)$ then $\optt{gap}(\alpha)$ or
$\optt{slice}(\alpha)$ or $\optt{azim}(\alpha) \sge \pi$.
\end{lemma}


\begin{lemma}\guid{GTVTJBG}  If $N$ is a node that is upright, then at least
