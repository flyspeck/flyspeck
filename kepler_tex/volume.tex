...
\tlabel{enum:null}
\indy{Index}{Properties!Null Set}
\indy{Index}{null set}
\indy{Index}{plane}
\indy{Index}{sphere}
...
\indy{Index}{null set}
\indy{Index}{ZZZequiv@$\equiv$}

\subsection{measurability}\label{sec:measure}
\indy{Index}{measure}
\indy{Index}{measurability}
...
\tlabel{enum:measure}
\indy{Index}{Measurable Set}
\indy{Index}{Properties!Measurable Set}
\indy{Index}{null set}
...
\end{enumerate}
\indy{Index}{Volume}
\indy{Index}{Properties!Volume}
\indy{Index}{linear stretch}
\indy{Index}{translation}
\indy{Index}{primitives}
...
\indy{Index}{Lebesgue measurable}
\end{itemize}
\end{lemma}

\subsection{radial set and solid angle}\label{sec:solid}
\indy{Index}{Radial Set and Solid Angle}
...
\indy{Notation}{ZZZopen ball@$B(x,r)$}
\end{definition}
...
the name.)
\indy{Index}{solid triangle}
\indy{Notation}{ZZZsolid triangle@$ST(v_0,S,r)$}
\end{definition}
...
\indy{Index}{apex}
\indy{Index}{cone}
\indy{Notation}{ZZZconic cap@$SC(v_0,v_1,r,a)$}
\end{definition}
...
\indy{Index}{rcone}
\indy{Index}{right-circular cone}
...
$a\in[0,1]$. The set $FR$ is given as
    ...
    $$
\indy{Index}{frustum}
\indy{Notation}{ZZZfrustum@$FR(v_0,v_1,h',h,a)$}
\end{definition}
...
\indy{Index}{Primitive Volume Calculation}
...
\indy{Notation}{ZZZorthosimplex@$\op{orth}^0(x,v_1,v_2,v_3)$}
\end{definition}
...
\indy{Index}{Finiteness and Volume}
