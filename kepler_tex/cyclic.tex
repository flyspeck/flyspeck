...
\begin{calculation}\guid{}\rating{ZZ}\label{calc:cc:d2b}
...
\begin{calculation}\guid{}\rating{ZZ}\label{calc:cc:qua}
...
Let $g(t) = \tau(y_1+t,y_2,y_3,y_4,y_5,y_6)$.
If $\Delta(y_1^2,y_2^2,y_3^2,y_{23}^2,y_{13}^2,y_{12}^2)> 0$, if
If $\Delta(y_1^2,y_4^2,y_3^2,y_{43}^2,y_{13}^2,y_{14}^2)> 0$, if\footnote{The function \op{cross} will be defined elsewhere. XX}
$$
...
then $g''(0)<0$.
\end{calculation}
% In this context, by Calculation~\ref{calc:cc:qua}, the function $\tau$ as a function of $t$ (with parameters $y_{13},y_1,y_4,y_{14}$) does not have a local minimum at $t=0$.
%This is contrary to the assumed minimality of $(V,E,F,G)$.
%(This is an interval arithmetic calculation~cc:qua in four variables.%% cc:quad tau-estimate, deform a quadrilateral.