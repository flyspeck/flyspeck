...
\ednote{@Sean: Will the structure of the wiki mirror the structure of the
...
We considered the following kinds of annotations desirable:
...
contributors step by step.  The Twelf pages are overwritten on every import from the
master source, whereas existing container pages remain untouched.
