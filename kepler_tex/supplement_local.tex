...
\begin{proof} This follows from Lemma~\ref{lemma:compact-fan} and
...
be given for some domain $T\subset\ring{R}$ independent of $i$.  
Assume $0\in T$ and $\varphi_i(0)=\v_i$.  Write $\v_i(t) = \varphi_i(t)$. 
...
\begin{lemma}[deformation\_ODXLSTC\_cs] \guid{KESHTYS} 
