...
%% WW Used??
%\begin{lemma}\guid{WXEZQZR}\tlabel{lemma:euler-alt}  Let $H$ be a plain planar hypermap with a single group orbit.
...
\begin{lemma}\guid{IYDMHUU}\tlabel{lemma:one-dart-one-node}
...
\begin{lemma}\guid{ARZBWRD}\tlabel{lemma:sum-no-fp}
...
\begin{lemma}\guid{PSMRXQT}\tlabel{lemma:sum-simple} 
...
\begin{lemma}\guid{JXZZWML}\tlabel{lemma:sum-plain}
...
\begin{lemma}\guid{TVTVZUD}\tlabel{lemma:sum-planar}
...
\begin{lemma}\guid{RIFTCTD}  Let $(D,e,n,f)$ be a plain hypermap.
...
\begin{lemma}\guid{SXRVGEU} Let $(D,n,e,f)$ be a plain hypermap.  
...
\begin{lemma}\guid{VBTIKLP}\tlabel{lemma:disjoint}\rating{50}
...
\begin{lemma}\guid{LTNRBQA}\rating{80}  
...
\begin{lemma}\guid{OEDRELV}\rating{100}
...
\begin{lemma}\guid{JLYQTPB}\tlabel{lemma:umu}\rating{100}
Let $(\orgn,V,E)$ be a fan.
Let $x=(\orgn,v,w,w')$ be a dart in the associated hypermap.
For all $\epsilon > 0$,
...
\begin{lemma}\guid{TOICXIA}\tlabel{lemma:face-component}\rating{10}
Let $(\orgn,V,E)$ be a fan.
...
\begin{lemma}\guid{NZRCEQT}\tlabel{lemma:approach-Ce}\rating{35}
...
\begin{lemma}\guid{AZRNUSY}\tlabel{lemma:Ux}\rating{25}
...
\begin{lemma}\guid{JDONNKL}\rating{25}
...
\begin{lemma}\guid{JJSVEPA}\tlabel{lemma:pre-walkup}\rating{20}
Let $(\orgn,V,E)$ be a fan and $(\orgn,V,E')$
...
\begin{lemma}\guid{LNKNVPH}\tlabel{lemma:join-comp}\rating{35}
Let $(\orgn,V,E)$ be a fan and $(\orgn,V,E')$
...
\begin{lemma}\guid{IRPGMRU}\tlabel{lemma:U-bij}\rating{30}
Let $(\orgn,V,E)$ be a fan and $(\orgn,V,E')$
...
%\begin{lemma}\guid{RQFUWXH}\tlabel{lemma:split-component}
...
\begin{lemma}\guid{OOCOCDU}\tlabel{lemma:U-merge}\rating{35}
Let $(\orgn,V,E)$ be a fan and $(\orgn,V,E')$
...
\begin{lemma}\guid{ILJJNGK}\tlabel{lemma:orbit-connect}\rating{35}
...
%%% EXIST DART
%%%
%\begin{lemma}\guid{ENJSZWC}\tlabel{lemma:dart-lead}
...
%\end{proof}
%
%\begin{lemma}\guid{FIIBFJR}\tlabel{lemma:dart-curve}
...
%for some $e\in E$.
%
%However, by Tarski arithmetic\tarf{miss-plane}, there is a 
...
\begin{lemma}\guid{KQRJETU}\tlabel{lemma:deform-invariant}
...
\begin{lemma}\guid{SJRGNXF}\rating{60} 
...
\begin{lemma}\guid{REZCYVI}\rating{50}  
...
\indy{Index}{convex}\indy{Index}{concave}\indy{Index}{weakly convex}
%
\end{definition}
...
\begin{lemma}\guid{QGATMJH}\rating{30}
...
\begin{lemma}\guid{UMZPAFC}\tlabel{lemma:path-case}\rating{400}
...
\begin{lemma}\guid{WHVQQLB}\tlabel{lemma:min-path}\rating{200}
Let $(\orgn,V,E)$ be a fan.  Let $U$ be a component of $Y(\orgn,V,E)$.
...
\begin{lemma}\guid{LGXSUBS}\tlabel{lemma:visr1}\rating{30}  
...
\begin{lemma}\guid{JGEHGYO}\tlabel{lemma:convex-vis}\rating{20}
Let $(\orgn,V,E)$ be a fan.  Let $U$ be a component of $Y(\orgn,V,E)$.
...
\begin{lemma}\guid{RAXFNJD}\tlabel{lemma:details}\rating{20}
...
\begin{lemma}\guid{PHMPEFB}\tlabel{lemma:path-arc}\rating{300}
Let $(\orgn,V,E)$ be a fan.  Let $U$ be a component of $Y(\orgn,V,E)$.
...
\begin{lemma}\guid{EYRRSJK}\tlabel{lemma:convex-face-simple}\rating{30}
...
\begin{lemma}\guid{HDRFIYR}\tlabel{lemma:concave-simple}\rating{30}
...
\begin{lemma}\guid{ZZPFZYF}\tlabel{lemma:convex-half-plane}\rating{150}
Let $(\orgn,V,E)$ be a fan.  
Let $U$ be a component of $Y(\orgn,V,E)$.
Let $F$ lead into $U$.
...
\begin{lemma}\guid{XWPWWFE}\tlabel{lemma:7-sides}
    \oldlabel{5.1.2}
Let $(\orgn,V,E)$ be a fan with cyclic hypermap.
...
\begin{lemma}\guid{YHBASEV}\tlabel{lemma:exists-diagonal}\rating{150}
 Let $(\orgn,V,E)$ be a fan.  Let $U$ be a component of $Y(\orgn,V,E)$.
...
\begin{lemma}\guid{DAADCNV}\tlabel{lemma:cx-dart}  
...
\begin{lemma}\guid{BICPVGX}[Jordan curve theorem]\tlabel{lemma:jct}\rating{50}
Let $(\orgn,V,E)$ be a fan.
...
\begin{lemma}\guid{CLEJEKW}\tlabel{lemma:quot-fan}
In this context,
...
\begin{lemma}\guid{BQZRMDY}\tlabel{dist2}\rating{400}
...
We have $|v_1-v_2|\ge2.91$ by Tarski arithmetic\tarfE{E:part4:10}.
...
It cannot be a subvertex by Tarski arithmetic\tarf{subvertex}.
...
$3.2$. In this case, Tarski arithmetic\tarf{dcg-1220} shows
that we have an
...
one large step.  Tarski arithmetic\tarfE{dcg-p142} now shows that
...
\begin{lemma}\guid{YHACLHD}\tlabel{lemma:4.12.3}
%%    \oldlabel{4.12.3}
...
$$
Hence, $r=1$.
Thus, $\op{aff}_+^0(v_0,\{v,v'\})\subset U$ and by Tarski arithmetic\tarf{cone-meet},
$$
  3.2 \le |v-v'| < 3.2.
$$
\end{proof}
...
\begin{lemma}\guid{ZFWIKSV}\tlabel{lemma:4.12.4}
%%   \oldlabel{4.12.4}
...
from the other. By Tarski arithmetic\tarf{cone-meet}, 
$$
3.07 \le |v-v'| < 1.815 + 1.255 = 3.07.
$$
\end{proof}

\begin{lemma}\guid{KBASWYI}\tlabel{lemma:4.12.5}
%%    \oldlabel{4.12.5}
...
follows from Tarski arithmetic\tarf{cone-meet}
