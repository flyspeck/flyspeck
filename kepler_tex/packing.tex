...
\end{displaymath}
Substitute the formula (\ref{eqn:sigma}) in, then use the bijection of
Lemma~\ref{lemma:coset} to replace the double union by a single union
over $\pi\in \op{Sym}(k+2)$.  Routine background facts in affine
...
\dfrac{\sqrt2-h}{\sqrt2-2}~ \dfrac{h_+-h}{h_+-1} ~\dfrac{17 h - 9 h^2 - 3}{5} 
