...
By property \cond{flat count}, it follows that $r+s> 4$.
...
However, an interval arithmetic calculation %XX
...
$\norm{\v_1(t)}{\v_2(t)}>2$.
It keeps $\tau$ fixed.  Hence the deformed fan is also a minimal.  However, the existence of this deformation contradicts property \case{flat middle}.
\end{proof}
...
Every minimal fan $(V,E,F,G)$ satisfies properties \case{flat extremal vertex} and \case{flat extremal vertex sym} for every $\v\in V$.
\end{lemma}
