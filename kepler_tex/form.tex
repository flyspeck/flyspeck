...
\index{Index}{Kepler conjecture} sphere packing problem.
\index{Index}{sphere packing problem}
...
of $Q\in\CalQ(\Lambda)$.
\end{definition}\index{Index}{context (of a quarter)}
