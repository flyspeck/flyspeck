...
%  I: add Gonthier's odd order (see 2/3 papers TPHOLs), Thompson spelling.
%  SML type safefy formalization after Leroy,  http://portal.acm.org/citation.cfm?id=1190215.1190245 
% add many citations.
...
%perhaps a larger initial investment is required to get started in a
%formal system.
...
landscape.
  There are several competing systems to choose from, %, with names like
...
%In HOL Light, all mathematical object are expressed as terms.
