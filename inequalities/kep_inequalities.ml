...
let I_572068135=
   all_forall `ineq 
    ...
    (
            (
                ( (tau_analytic_x x1 x2 x3 x4 x5 x6) -.  (  (#0.2529) *.  (dih_x x1 x2 x3 x4 x5 x6))) >. 
                (--. (#0.3442))) \/ 
...
let I_900212351=
   all_forall `ineq 
    ...
    ( (vor_0_x x1 x2 x3 x4 x5 x6) <.  (  (#1.798) +.  (  (--. (#0.1)) *.  ( (sqrt x1) +.  (sqrt x2) +.  (sqrt x3))) +.  (  (--. (#0.19)) *.  (sqrt x4)) +. 
        (  (--. (#0.17)) *.  ( (sqrt x5) +.  (sqrt x6)))))`;;
...
let J_550901847=
   all_forall `ineq 
    ...
    ( (tau_analytic_x x1 x2 x3 x4 x5 x6) >.  (  (#0.55) *.  pt))`;;
...
let J_559163627=
   all_forall `ineq 
    ...
    ( (tau_analytic_x x1 x2 x3 x4 x5 x6) >.  (  (#2.0) *.  (#0.55) *.  pt))`;;
...
let J_571492944=
   all_forall `ineq 
    ...
    ( (tau_analytic_x x1 x2 x3 x4 x5 x6) >.  ( (--. (#0.29349)) +.  (  (#0.2384) *.  (dih_x x1 x2 x3 x4 x5 x6))))`;;
...
let J_471806843=
   all_forall `ineq 
    ...
    ( (tau_analytic_x x1 x2 x3 x4 x5 x6) >.  ( (--. (#0.26303)) +.  (  (#0.2384) *.  (dih_x x1 x2 x3 x4 x5 x6))))`;;
...
let J_599117591=
   all_forall `ineq 
    ...
    (
        (
            ( (tau_analytic_x x1 x2 x3 x4 x5 x6) +.  (  (--. (#0.0845696)) *.  (sqrt x1)) +.  (  (--. (#0.0845696)) *.  (sqrt x2)) +. 
