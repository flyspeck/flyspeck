...
\indy{Notation}{h@$h$!permutation on darts}
...
\indy{Notation}{emptypath@$[]$ (empty path)}
\end{definition}
...
\indy{Notation}{We@$W_e$ (walkup)}
\indy{Notation}{Wf@$W_f$ (walkup)}
\indy{Notation}{Wn@$W_n$ (walkup)}
\end{definition}
...
\indy{Notation}{Zp@$\varphi$ (morphism of hypermaps)}
\end{definition}
...
\indy{Notation}{D@$D$ (set of darts)}
...
\indy{Notation}{HquotientL@$H/{\cal L}$}
\indy{Index}{cover}
...
\indy{Notation}{H@$H$ (restricted hypermap)}
\end{definition}
...
\indy{Notation}{d3@$d\ge 3$ (upper bound)}
