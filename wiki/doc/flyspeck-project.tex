...
\label{sec:flyspeck}
  The target of our case study is the Flyspeck Project\ednote{reference}, which seeks
...
\item A way to download the definitions and lemmas statements and proofs (when they exist).\ednote{FR: What about downloading only those parts needed for a certain lemma?}  %
