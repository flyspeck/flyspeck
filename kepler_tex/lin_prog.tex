...
sphere packing problem has been the linear programming.  The proof
...
Flyspeck project, which aims to give a formal proof of the sphere packing
...
these points of view.  To understand the 1998 solution to the sphere
...
To solve the sphere packing problem, it is enough to show that no
...
solution to the sphere packing problem.  Another chapter will show that
...
part of the sphere packing problem in a way that is conducive to
...
one of the main parts of the sphere packing problem.
...
The combinatorial structure of the sphere packing problem is expressed
...
The linear programming problems in this chapter are {\it
...
programming without reference to the specifics of the sphere packing
...
published solution to the sphere packing problem in \cite{DCG} (Section
...
arise in the proof of the sphere packing problem.  These are the {\it
...
Bound and the proof of the sphere packing problem, it is necessary to
