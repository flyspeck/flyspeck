...
representation of this lemma and everything it depends on.  Assuming that the
Flyspeck book is written in a linear order, this could be all definitions and
lemmas \emph{before} the current one in the narrative order of the book.
