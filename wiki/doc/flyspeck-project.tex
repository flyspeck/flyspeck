...
been expressed in a proof assistant.  Note that the computerized 
definitions and proofs are examples of a ``document'' in the sense
of section \ref{sec:science})
