...
stated properties will be assumed without proof. \footnote{Harrison has already implemented gauge integration, which is much
...
called \newterm{primitive regions}, is provided by Definition~\ref{def:primitive}.  These
