...
\begin{lemma}[]\guid{CKQOWSA}\rating{1800}\label{lemma:std-fan}
...
two facts from Tarski arithmetic.\footformal{Further details about these calculations
can be found in the 1998 proof \cite{Hales:2006:DCG}.}
\begin{itemize}
...
$\norm{\v_0}{\v_2}\le 2\hm$.  Then $C\{\v_1,\v_3\}\cap
C\{\v_0,\v_2\} = \{\orz\}$.
\end{itemize}
\end{proof}
