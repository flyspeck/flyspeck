...
The first section was all about the work of mathematicians who have
used computers calculations in their proofs.  This section is about
doing the proofs themselves by computer.  I have never been able to
get used to it being mathematicians who use computers for calculation
and the computers scientists who use computers for proofs.  I hope the
...
says ``leads to nothing'') and ``real proofs''~\cite[p.~4]{HPSH}.
...
etc.).  If the types are interpreted naively as sets, then $x:A$
...
\]
(from $A$ and $A\text{-implies-}B$ follows $B$) is identified with
the function application; from $x:A$ and $f:A\rightarrow B$ we get $f(x):B$.
