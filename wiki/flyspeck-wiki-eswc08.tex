...
\ednote{It will be some effort to distance our approach from the ProofWeb
  wiki~\cite{CorKal:CoopReposFormalProofs07} or Logiweb~\cite{Grue:Logiweb07}, to explain
  why we're not doing it their way. Actually, the Semantic Web community might not care,
  as they do not know our competitors, but the MKM community will care. --CL}
