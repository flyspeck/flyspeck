...
\ednote{Both the introduction (sections
1 and 2) as well as the related work (section 5) could be shortened to
provide more space for this crucial core section (evaluation).}
...
\begin{wrapfigure}{r}{4.2cm}
  ...
  \vspace{-1.2cm}
\end{wrapfigure}
\ednote{The first figure "B. Buchberger, 1995" is not referenced from within
text, does not have a caption and is not readable when the page is
printed on A4 page}
...
Common instances are taking\ednote{writing} down first hypotheses,
