...
\xfootnote{An alternative proof uses the open cover of compact ball 
...
%\xfootnote{The  notation follows the syntax of Python slices.} 
$\trunc{\bu}{j} = 
...
{\it length} of the list $\bu$ (which is $k+1$).\xfootnote{Compare this
