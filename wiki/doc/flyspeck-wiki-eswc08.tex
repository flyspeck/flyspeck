...
the current page as subject or object are available, they are displayed in the box with
navigation links offered by IkeWiki.  Adding more ontology-powered services, particularly
ones that facilitate editing documents, is planned for version
0.3~\cite{swim-roadmap}\ednote{add BibTeX for SWiM Web 2.0 paper}.

\ednote{@CL: Screenshot!}
