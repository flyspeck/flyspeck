...
%$\Omega(v,\Lambda)$ at the origin, and so forth, because these structures
...
%been lost.}
%% XX GLOBAL REPLACE \svor with sovo.
      $$
      \begin{array}{lll}
...
terms are weighted averages of the terms $\op{sovolan}(S,c,v_i)$. %% TYPO?XX
