...
If $h(\bv) < \sqrt2$, then $c(\bu)=c(\bu')$ is a $4$-cell in the wedge,
...
\begin{definition}[small~leaf,~subcritical,~supercritical]
...
\begin{lemma}\label{lemma:ox2} There exists a quarter with $\gg<0$ and flanked on both sides by another $4$-cell.
\end{lemma}
...
\begin{lemma} Let $\QX$ be a cell with one small leaf and the other with $\eta^+$.
Then $\gg > \eps$ or $\QX$ is a $\beta$-cell.  Let $\QU$ be a cell with one leaf $\eta^+$.  Then $\gg > \eps$.
\end{lemma}

\begin{proof} This is a \cc{gl4 fhvb2}{}.
\end{proof}
...
\begin{remark}[neutralize]  $\gg_{\QU} > -\eps$ and $\gg_{\QX}\ge 0$ by a \cc{gamma\_qu gamma\_gx}.
...
\begin{lemma} The case $C_{3,3}$ does not occur.
\end{lemma}
...
gaz6 & ineq & QITNPEA 3848804089 & $\QU\Rightarrow (\gg,\azim)$\\
...
azim2 & ineq & QITNPEA 9939613598 & $\QX^{ss,super}\Rightarrow (\gg,\azim)$\\
azim\_c4 & ineq & BIXPCGW 6652007036 a2 & $\QU,\QX\Rightarrow \azim < 2.8$\\
gl4 & ineq & GLFVCVK4 2477216213 y4... &$\QX\ \not\beta\Rightarrow \gg >\eps$\\
fhbv2 & ineq & FHBVYXZv2 a &$\QU\  \eta^+ \Rightarrow \gg > \eps$\\
ztg4 & merge & ztg4 & $\QX,\QU\Rightarrow (a_5,b_5)$\\
pem & ineq & PEMKWKU & $\QY\ldots \Rightarrow (a_5,b_5)$\\
...
txq & ineq & TXQTPVC, IXPOTPA & $\QY\ldots\Rightarrow \gg > 3\eps$\\
ox3q1h & merge & ox3q1h\_merge & $3\QU+1 B\Rightarrow\sum_4 \gg > 0$.\\
