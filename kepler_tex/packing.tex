...
The proof fills up most of this book. This section describes the
...
The Kepler conjecture is a statement about packings that fill Euclidean space.
If the center of each ball is parameterized by its three coordinates, the description
of a packing requires a countable number of real coordinates.  The first task
in resolving the conjecture is to reduce the number of coordinates to a finite number.
This is accomplished by Lemma~\ref{lemma:deltabound}.  
...
of $T$.  In two dimensions, the bound is sharp and gives a solution to
