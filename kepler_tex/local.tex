...
The proof then
follows from a \cc{4717061266}{A certain configuration of four points
...
\item \case{minimal~node~flat~\ref{l:mnf}} For every $\v\in V$, if $\v$ is flat and if $\{\u,\v\}\in
E\setminus S$, then $\norm{\u}{\v}=2$ or $\normo{\v}=2$.
...
\item \case{card~\ref{l:c}} %$k=\card(F)$,
Let      $s=\card(S)$ and $r=\card(E) - s = \card(F)-s$.  Then
\[ 0\le s \le 3\textand 3-s \le r \le 6 -
2s.\] 
