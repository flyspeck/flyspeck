...
1997 (in Java~\cite{Java}), and 2000 (in Java). The same computer
...
linear programming package CPLEX~\cite{Cplex}. In preparation for a
...
By \cite[Eqn.~7.12]{Hales:2006:DCG}, inclusion-exclusion gives\FIXX{Double check.}
