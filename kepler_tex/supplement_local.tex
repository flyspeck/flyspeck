...
we have $a_{i,j}(s)\le\stab <\norm{\v_i}{\v_j}$ and $4h_0<b_{i,j}(s)$.  
Assume $\angle \v_i < \pi$ for all $i\ne p+2$.
Assume $\op{xrr}_V(\v_{p-1},\v_{p+1})<15.53$
...
\begin{lemma}[]\guid{PWEIBZ} Let $(s,v)$ satisfy the running assumptions.  Then $\norm{\v_p}{\v_{p+1}}=2$
for every standard edge.
\end{lemma}

\begin{proof} Assume $(p,p+1)$ standard.  If $\v$ is not straight at $p$ and $p+1$, then YEBWJNG
gives the result.  By symmetry, we may now assume without loss of generality that $\v$ is straight at $p$.
...
For a contradiction, we may assume that $\norm{\v_p}{\v_{p+1}}$ is not minimal.  By IMJ, $\normo{\v_p}=2$.
By deformation 482, we also have $\angle \v_{p+1}$ is not obtuse.
...
extremal edges $(p+1,p+2)$ and $(p+2,p-1)$ is minimal.  By the symmetry reduction above,
 $\norm{\v_{p+1}}{\v_{p+2}}\le 2h_0$.   By a \cc{6184614449~1348932091~5557288534}{}, 
...
\cc{2073661826~8405387449~9368433105~5550839403}{},
using obtuseness at $\angle\v_{p+1}$, we have $\angle \v_p < \pi$, a contradiction.
\end{proof}
