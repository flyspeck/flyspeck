...
formal proof is not the same as a formal proof, which is in fact a 
fleeting pattern of bits in a computer.  The book instructs the
human\footnote{``The words [of the book] will be minced into atomized search-engine
...
The expression $\alpha_1+\alpha_2+\alpha_3-\pi$ is \newterm{Girard's
  formula} (known first to Hariot) for the area of a spherical
...
% \indy{Index}{Girard, A.}%
% Albert Girard's Book on trigonometry was published in 1626. Hariot
% lived 1560 - 1621.
...
Formal proofs have been constructed of all of the major results in
this chapter.  In fact, many of the formal proofs of results that
appear early in the chapter are part of standard distribution of the
HOL Light proof assistant.  Jason Rute, during the summer before
starting graduate work at Carnegie Mellon University in 2008,
...
functions $\ups$ and $\Delta$.  Euler's theorem was formized by Vu
Khac Ky and Trieu Thi Diep.
