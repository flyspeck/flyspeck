%% This is a dead-end attempt to do estimates on standard regions
%% in a systematic way.  I'm now using a rooted tree approach instead
%% on assembly problems.  This was written I believe around
%% the beginning of 2005.  (TCH - Oct 8, 2007)
