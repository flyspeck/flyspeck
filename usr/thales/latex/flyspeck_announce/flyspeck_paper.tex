...
is closely related to that of other proof assistants in the HOL family
and is based on a lambda calculus with simple polymorphic types. The
type system, the term constructors, and the theorem constructors of
HOL Light are contained in an extremely small kernel of a few hundred
...
implementation in code is free of bugs~\cite{DBLP:conf/itp/KumarAMO14}
