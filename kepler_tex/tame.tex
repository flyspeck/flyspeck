...
%
 ...
 \index{ZZdzeta@$\zeta= 1/(2\arctan(5,\sqrt{2}))$}
...
Chapter~\ref{sec:def-and-class}. These hypermaps are called
...
\begin{definition}  Let $(\Lambda,v_0)$ be a contravening
