...
m_0 &= 2\pi - 10\Delta_0\\
m_1 &= \Delta_0\sqrt2/m_0 = 1.012\ldots \\ %% K 
m_2  &= (6\Delta_0- \pi)\sqrt2/(12 m_0) = 0.0254\ldots\\ %% M 
M(h) = &=
\begin{cases}
...
We call a $4$-cell a {\it quarter}, when it has exactly one critical edge and all other edges of the simplex have length at most $2 h_-$. By calculations~\cite[cc:qtr]{hales:2009:nonlinear}, if $X$ is any cell, then % gamma2 is nonneg on quarters.
$$
 \gamma_2(X) \ge 0,
$$ 
...
by a calculation~\cite[cc:2bl]{hales:2009:nonlinear}. % 2-blade calculation, gamma2(fourcell)+gamma2(threecell) >=0.
...
for the arcradius of this disk.  We can verify directly that~\cite[cc:alin2]{hales:2009:nonlinear} %% Linear lower bound on regular polygon.
