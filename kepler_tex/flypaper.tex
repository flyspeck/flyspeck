...
\usepackage{tikz}
\usetikzlibrary{chains,shapes,arrows,trees,matrix,positioning,intersections,decorations,backgrounds,fit,calc,fadings,decorations.pathreplacing}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \tocpart{And Beyond}
    %\linput{further}
    %\input{formal_proof} %% REMOVE FROM BLUEPRINT, ALREADY PUBLISHED.
    %%\end{runninglinenumbers*}
    \appendix
    %\input{numerical} %% REMOVE FROM BLUEPRINT, OUT OF DATE.
    \newpage
    %\input{credit}
