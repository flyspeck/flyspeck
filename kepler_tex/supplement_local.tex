...
\begin{lemma}[lunar prep]\label{lemma:lunar-prep}
...
\begin{lemma}[lune]\label{lemma:lune-main}
...
\begin{lemma}[propagate-min-std]\label{lemma:propagate-min-std}
...
\begin{lemma}[propagate-min-std2]\label{lemma:propagate-min-std2}
...
\begin{lemma}[propagate-min-std3]\label{lemma:propagate-min-std3}
Let $s$ be an unadorned SCS, and let $\v\in \MM_s$ be generic.  Assume that $J=\emptyset$. Assume that
for all diagonals $\{i,j\}$, we have
$a_{ij}(s)\le \stab < \norm{\v_i}{\v_j}$.
...
\begin{lemma}[equivalent diagonal]\label{lemma:equivalent-diagonal}
...
We specify an unadorned scs with the parameters
...
\begin{lemma}[hex slice]\label{lemma:hex-slice}
We have
\[
...
\begin{lemma}[hex slice2]\label{lemma:hex-slice2}
We have
\[
s(6I1,\{0,3\}) \Ra \{4M1\}.
\]
...
\begin{lemma}[hex slice 3]\label{lemma:hex-slice3}
