...
lattice $M$ of points in the $A_2$ arrangement. That is, $M$ is a
...
which $M'$ can be placed closely below $M$  (Figure~\ref{fig:two-holes}). As packing is constructed
...
%balls is the same.  Call this local tangent arrangement the
...
triangle $ABC$, first replace it with a smaller similar triangle whose
