...
the partition (\label{eqn:U}) of $U$ gives three pieces
...
XX give more detail about the polar polygon.  (In fact, we have a polar fan.)

\subsection{area}

XX Insert deformation of polygon attributes needed for area formula.
...
\begin{lemma}  Let $P$ be a polyhedron with an interior point $\orgn$.
...
\begin{remark} XX. We also need the fact that Marchal's circular disks lie in
different components $Y(\orgn,V,E)$.
\end{remark}
