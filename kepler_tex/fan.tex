...
\begin{nomerate}
\item \case{acuteness} $(V,E)$ is acute angled.
...
\begin{definition}[non conforming fan]
A fan $(V,E)$ is said to be non conforming if the following conditions hold.
\begin{itemize}
...
The property \case{bijection} of fans with conforming faces  holds for any non conforming fan:
$F\mapsto U_F$ is a bijection
\end{lemma}

\begin{proof}  Let $(V,E)$ be a fan with conforming faces.    
...
\begin{lemma}\guid{TXFBALB}\rating{ZZ}  Let $(V,E)$ be any non conforming fan.  Then it has property \case{solid angle} of fans with conforming faces.
\end{lemma}
...
\begin{lemma}\guid{GGZWYRM}\rating{ZZ}  Let $(V,E)$ be any non conforming fan.  For any dart $x$ on any face $F$ and dart $z\in F$ that is not adjacent to $x$ under the face map, 
$$
...
\begin{lemma}\guid{HYUAZSE}\rating{ZZ}   Let $(V,E)$ be a non conforming fan.  Then  property \case{half-space} of fans with conforming faces holds for $(V,E)$.
\end{lemma}
\indy{Index}{component!topological}%
...
%Let $(V,E)$ be any non conforming fan.  Then a triangulation of $(V,E)$ exists.
%\end{lemma}
%
...
In fact, $N(V,E)>0$, for otherwise $(V,E)$ has conforming faces by Lemma~\ref{lemma:N=0}.

This
is a non conforming fan.  The preceding lemmas show that a non conforming fan satisfies all of the properties of a fan with conforming faces.  This is contrary to the definition of non conforming.  This contradiction gives the proof.
\end{proof}
