...
and
  ...
  $$
\index{Index}{D@\ensuremath{D(\y{(3,1)})}}
\index{Index}{Z@\ensuremath{Z(\y{(3,1)})}}
\index{Index}{D@\ensuremath{D_{3,1}}}
\index{Index}{Z@\ensuremath{Z_{3,1}}}
...
We have that $2\sqrt{2}\ge|w-v_0|$ and by Tarski arithmetic\tarf{E:part4:1},
...
Tarski arithmetic\tarf{pass-anchor}).
...
length less than $2t_0$, by Tarski arithmetic\tarf{E:part4:4},
...
height is $\ge2.6$ by Tarski arithmetic\tarf{last:E} and the top face of the
