...
%(\cite[\S2.1]{DCG}
%gives the reasons behind the parameter $t_0$.)  
...
This article settles on a compromise.
...
%% XX Need permissions. Or need to generate new image.
\begin{floatingfigure}{30mm}
  \begin{center}
...
$$
%%XX I don't think this term is used.
...
Add edges to the graph $G(\Lambda)$ 
as follows.  
...
\end{enumerate}
%% XX I think it is better to use the constant 3.07-t_{dod}. This is done below.
...
\begin{proof} (Sketch)  By defintions,
...
%% XX I'm not sure what role the sqrt8 plays in this proof.
...
Appendix~\ref{XX} gives a finite set of constraints $\Phi_{dod}$, 
specified
