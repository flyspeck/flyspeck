...
for all darts $x\in D$.  Let $u = v_x$, $v_0 = v_{f x}$,
...
for all darts.  Then
\begin{itemize}
\item For every face $F$ of the hypermap, there exists a topological component
$U$ of $Y$ such that for every $x\in F$, the dart $x$ leads into $U$.  Write
$U_F$ for this topological component.
