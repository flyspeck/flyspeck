...
hypermaps.  I also made hypermaps into a heavyweight object, in the
...
Several lemmas use the following natural numbers $m,p,q$ and darts $y,z$ described
in the following definition.  In the pencil-pen analogy, the dart $y$ marks the tip of
the pen as it is about to draw a simple arc. The dart $z$ marks the endpoint of that
arc.  The integers $m,p,q$ track how far the pen has progressed in tracing the edges of
a  face, how many nodes appear on the arc about to be drawn,  and how $z$ sits
in relation to $y$ in the current pen sketch.
...
assumed simplicity of the subquotient $H/{\cal L}$.)
...
$\card(\Omega)$ darts and such that the largest face has size $d$ is
...
%  to $D$ and whose greatest face size is $d$.  It has a subquotient
