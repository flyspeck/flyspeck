...
\def\ups{\upsilon} % Needs txfonts; else use \upsilon
\def\mid{\ :\ }
\def\orgn{\vartheta} % center of packing
...
%% Indexing
\def\showref#1{\ref{#1}{\tt[#1]}\index{#1}}
...
\def\assembly#1{{\textsc{assembly-#1}}\index{ZD{#1}@{#1}}}
