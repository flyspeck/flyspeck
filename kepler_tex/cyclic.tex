...
\begin{definition}[cyclic fan]\guid{CODE} 
A triple $(V,E,F)$ is a \newterm{cyclic
...
\begin{remark}[visualization]\guid{CODE}
...
\begin{definition}[$\rho$,~$\v$]\guid{CODE} 
...
\begin{definition}[interior angle,~$\angle$,~$\bWdart$]\guid{CODE}
...
\begin{definition}[localization]\guid{CODE}
...
isomorphic to $H_{2k}$, where $k= \card(F)$.  Finally, the angle
...
\begin{definition}[generic,~lunar,~circular]\guid{CODE}
...
\begin{definition}[flat]\guid{CODE}
...
\begin{definition}[deformation]\guid{CODE}
...
\begin{definition}[perimeter]\guid{CODE}\label{lemma:perim}
...
\begin{definition}[special~fan,~$\hm$]\guid{CODE}
Let $\hm = 1.26$.
...
\begin{definition}[$\hm$,~$\tau$,~$\dih_i$]\guid{CODE}\label{def:tau}
...
\begin{definition}[fan~datum]\guid{CODE}
...
\begin{definition}[slice]\guid{CODE}
...
\begin{definition}[minimal~fan,~$k_{min}$,~$\tau^d_{min}$]\guid{CODE}
...
\begin{definition}[extremal,~minimal]\guid{CODE}
...
\begin{definition}[irreducible]\guid{CODE}
