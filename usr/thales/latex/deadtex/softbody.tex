...
\subsection{github download}\label{sec:google-code}
...
\footnote{\url{http://code.google.com/p/flyspeck/source/checkout}} % 
 page.
That page
lists the command to anonymously check out the source code:

It is possible to check out part of the project. 
