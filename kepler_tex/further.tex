...
\begin{lemma} The strong dodecahedral conjecture implies the
...
\begin{lemma} Two $D_k$-cells either intersect in a set of measure
...
\begin{proof} This proof imitates the proof of the main estimate from
  ...
  {\bf Case 1}: {\it Assume $r+s\le6$ and there is a concave dart.}  A
...
{\bf Case 2:} {\it Assume that every dart is convex.}  Every edge has
...
{\bf Case 3:} {\it Assume that $r+s>6$ and there is a concave dart.}
...
\begin{theorem}\guid{ZXZSVPH} The standard hypermap of a centered
