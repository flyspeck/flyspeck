...
defining relation, there are multiple versions of theorems about
...
darts $[x_0;x_1;\ldots;x_{k-1}]$ such that for each $i$, $x_{i+1} = h_i x_i$ for some $h_i \in S$.   A \newterm{sublist} of a list is a consecutive
...
graphs, we  often depict hypermaps with the darts in a node
...
(These details are not  available to us in the algorithm of the
...
The proof is presented below.  The proof is a matter of
