...
\def\smalldot#1{\draw[fill=black] (#1) circle (0.02)}
...
\def\ruessgq{
\tikzfig{cosadd}{\guid{RUESSGQ} An intuitive derivation of the cosine addition law comes
by writing the rectangle area $(s_x+c_y)(s_y+c_x)$ as the sum of the area pieces
$2 s_x s_y + c_y s_y + c_x s_x + c_{x+y}$, where $s_x =\sin x$, $c_y = \cos y$, etc. The
derivation in the text is less intuitive, but formally simpler.
}
{
[scale=2.8]
...
\def\itgcyif{
\tikzfig{affset}{\guid{ITGCYIF} Examples of $\op{aff}_+(V,V')$ when $\card(V)+\card(V')$ is
$2$ or $3$.}
{
[scale=3.0]
...
\coordinate (P1) at (1,0);
\coordinate (P2) at (60:1);
\draw[fill=gray!40,draw=gray!40] (P0) -- (0:1.2) arc (0:60:1.2)--cycle;
\smalldot{P0};\smalldot{P1};\smalldot{P2};
\draw[->] (P0) -- (P1) -- +(0.3,0);
\draw[->] (P0) -- (P2) -- +(60:0.3);
\end{scope}
...
\def\gjrslpt{
\tikzfig{dih}{\guid{GJRSLPT} The dihedral angle $\theta$ between two planes is calculated by
projection to a plane with normal $\v_1-\v_0$.
}
{
[scale=1]
\draw[step=0.2,gray,very thin] (-2,-2) grid (2,2);
\draw[<->] (-2,0)--(2,0);
\draw[<->] (0,-2)--(0,2);
\coordinate (P0) at (0,0);
\coordinate (P1) at (1,0);
