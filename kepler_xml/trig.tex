...
then the angle $\gamma$ formed by $u$ and $v$ at the origin is
    \begin{equation}\label{eqn:angle}
    \gamma = \frac{\pi}2 - \arctan\left (\frac {u\cdot v}{\sqrt{(|u|^2|v|^2 -
    (u\cdot v)^2)}}\right).
    \end{equation}
...
\begin{proof}
    ...
    comes by the $\arccos$-$\arctan$ relation Lemma~\ref{lemma:arccos-arctan}.      
...
rotations of the coordinate axes $e_1$ and $e_2$  (Equation~\ref{eqn:rotate}).
\end{proof}
...
Write $v_i$ in cylindrical coordinates as 
   ...
   \begin{array}{lllll}
    ...
    \end{array}
   $$
By the definition of $\op{azim}$, we have $\op{azim}(0,w,v_1,v_2)=\theta$.  
