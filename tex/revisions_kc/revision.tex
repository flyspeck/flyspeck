...
The deformation is allowed to assume configurations in which the distance between some $u\in U$ and the upper endpoint of an unerased upright diagonal is less than $2$.
...
\footnote{XX Check the proof from here.}
