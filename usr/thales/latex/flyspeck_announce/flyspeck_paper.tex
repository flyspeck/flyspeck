...
Kepler conjecture, and we refer the reader to \cite{DSP}.  We simply
...
%Ideally, all parts of the
%proof could be exported as proof objects and brought together during
%replay in the same session, but with the present resources this was
%only possible for the main statement.
...
%As each proof script runs, it extends the source code of HOL Light.
