...
This foam inspired the bubbly structure of the Water Cube building in the 2008 Beijing Olympics.
}
\label{fig:PW}
\end{figure}
...
dots are joined by a segment are not.}
\label{fig:e8}
\end{figure}
...
on tactics (called tacticals).  Figure~\ref{fig:tactic} shows the most commonly used commands in
HOL Light.  The most common tactic is {\it rewriting}, which takes a theorem
