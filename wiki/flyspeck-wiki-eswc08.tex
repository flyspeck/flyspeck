...
\issue{What kind of logics/proving techniques will be used? --CL}
...
formal and informal aspects of mathematical knowledge\ednote{Already mention OMDoc, which
  covers both, here? --CL}, content markup


\subsection{Semantic Wikis for Mathematics (Christoph)}
\label{sec:semwiki}

\issue{I'm never sure what to put into the state of the art section and what into related
  work.  I'm always in favor of having an elaborate state of the art section, discussing
  advantages and disadvantages of the other approaches, and then elaborating on mine that
  tries to do better.  Then I use to end up without an explicit ``related work'' section,
  but the scientific community does not seem to like this.  Do you have a rule of thumb
  what I should do? Thanks, Christoph}
...
\begin{todo}{It will be some effort to distance our approach from the ProofWeb
    wiki~\cite{CorKal:CoopReposFormalProofs07} or Logiweb~\cite{Grue:Logiweb07}, to
    explain why we're not doing it their way. Actually, the Semantic Web community might
    ...
    why we're going a different way.}
