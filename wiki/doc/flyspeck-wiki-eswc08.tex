...
\begin{abstract}
  ...
  In this paper we evaluate the applicability of semantic wikis to mathematical knowledge
  management, focusing on the Flyspeck use case: With lessons learned from a
  rapid-prototyping study with Semantic MediaWiki, we establish a roadmap how to improve
  our own, mathematics-specific semantic wiki SWiM to meet the needs of the Flyspeck
  collaborators even better.\ednote{@Christoph: revise!}
\end{abstract}
