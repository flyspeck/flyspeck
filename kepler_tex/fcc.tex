...
triangle (Figure~\ref{fig:pascal}).
\footnote{Harriot was well-versed in Pascal's triangle long
  before Pascal.}  Through his study of triangular and pyramidal numbers,
Harriot later discovered finite difference interpolation~\cite{BeS08}.
Shirley, Harriot's biographer, writes that it was
