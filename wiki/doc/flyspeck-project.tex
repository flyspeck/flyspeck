...
\ednote{SM: I dropped Mizar.  We're low on space.}
...
\ednote{@C. I think this (text commented) should be excluded.  we don't really talk about 
it later, and it's kind of obviously satisfied by this project}
%  We are going to investigate whether the three %
% conditions for successful peer production stated by Tapscott and %
% Williams\cite{wikinomics} will hold or can be satisfied by software %
% support.  The conditions are %
