...
\usepackage{url}
\usepackage{pdfsync}
%\usepackage[rflt]{floatflt}  %% Package is too unstable to use.
...
%FIWW{Double check: see Flypaper: lemma:sovo:rog}
...
%when $n\ge 3$, $0\le k\le n$, and $n+k\ge 5$.  With these definitions,
%when $n_1,n_2\ge 3$, $0\le k_1\le n_1$, $0\le k_2\le n_2$ and $n_1+k_1,n_2+k_2\ge 5$,  
