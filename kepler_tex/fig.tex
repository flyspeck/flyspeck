...
\def\figYAHDBVO{
\tikzfig{marchal-polyhedron}{\guid{YAHDBVO} A set of points $\w_i$
can be constructed around a disk of radius $r$ inside 
a given polyhedron $P$ in $\ring{R}^2$
}
{
[scale=1.0,z={(0,0)}]
\pgfmathsetmacro\r{1.0}
\coordinate (V1) at (-1.40573615605411817: 2.43152527011496122);
\coordinate (V2) at (62.2310998421659392: 1.00101500229540341);
\coordinate (V3) at (166.419445012932584, 1.80579527399678152);
\coordinate (V4) at (206.27916875919712, 1.23501080990908485);
\coordinate (V5) at (293.766402309343221, 1.09228179599956721);
\coordinate (W1) at (-1.40573615605411817: 1);
\coordinate (W2) at (62.2310998421659392: 1.00);
\coordinate (W3) at (166.419445012932584, 1.);
\coordinate (W4) at (206.27916875919712, 1.);
\coordinate (W5) at (293.766402309343221, 1.0);
\draw[fill=gray!20] (0,0) circle (1.0);
}}

\def\figZXEVDCA{
\tikzfig{marchal-polyhedron}{\guid{ZXEVDCA} By extending planes through
their circular boundaries, 
disks $D_i$ on the unit sphere 
determine a polyhedron.
}
{
[scale=1.5,z={(0,0)}]
 \draw[ball color=gray!10,shading=ball,semitransparent] (0,0) circle (1); % ball
