...
\end{equation}
among all (local) counterexamples that have parameters that satisfy $k_{min}=k$.}  Indeed,
...
\claim{In a minimal counterexample, there is exactly one
concave dart.}  Otherwise some minimal counterexample has
...
\claim{In a minimal counterexample, there cannot be exactly
one concave dart.} Otherwise, $U_F$ is star
