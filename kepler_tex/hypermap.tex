...
\begin{lemma}\guid{EUXPBPO}\rating{XX}\label{lemma:3dart}  
...
\begin{lemma}[Knaster-Tarski]\guid{EAOGWLE}\rating{XX}   Let $X$ be a set.  Let $f:\powerset(X)\to \powerset(X)$ be a function from the powerset of $X$ to itself.  Assume that $f$ is monotonic in the sense that whenever $Y\subset Z\subset X$, it follows that
