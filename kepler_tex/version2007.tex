...
\def\svninfo{Version -- September 5, 2007  LOCAL:SVN:52}
\usepackage{graphicx}
\usepackage{verbatim}
\usepackage{latexsym}
\usepackage{amsfonts}
...
\mainmatter
    ...
    \input{trig}  % Also contains chapter on Vector Geometry
    % removed construct_measure.tex from project.
    \chapter{Volume Calculations}
    \input{primitive_volume}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \input{form}
    \input{local_opt} % internal chapter
    \input{fine}
    \input{part4}
