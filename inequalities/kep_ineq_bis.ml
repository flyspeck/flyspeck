...
(* now for the 2.25, 2.22 PAIR on lemma:1.04, BLUEPRINT *)


let I_6337649845_GEN=
   `(\ a1 a2 a3 a4. (ineq
[
((#8.0), x, (square (#4.0)))]
   (vor_0_x a4 a1 a2 (#4.0) x (square (#2.25))  +
    vor_0_x a2 a3 a4 (#4.0) x (square (#2.22)) < -- (#1.04) * pt) \/
    delta_x a4 a1 a2 (#4.0) x (square (#2.25))  < (#0.0) \/
    delta_x a2 a3 a4 (#4.0) x (square (#2.22)) < (#0.0) \/
  (cross_diag_x a1 a2 a4 x (square (#2.25)) (#4.0) a3 (#4.0) (square (#2.22)) < sqrt8)))`;;

let I_6337649845_GEN2=
   `(\ a1 a2 a3 a4. (ineq
[
((#8.0), x, (square (#4.0)))]
   (vor_0_x a4 a1 a2 (square (#2.2)) x (square (#2.25))  +
    vor_0_x a2 a3 a4 (#4.0) x (#4.0) < -- (#1.04) * pt) \/
    delta_x a4 a1 a2 (square (#2.2)) x (square (#2.25))  < (#0.0) \/
    delta_x a2 a3 a4 (#4.0) x (#4.0) < (#0.0) \/
  (cross_diag_x a1 a2 a4 x (square (#2.25)) (square (#2.22)) a3 (#4.0) (#4.0) < sqrt8)))`;;


let mk_6337649845 i=
  all_forall (list_mk_comb( I_6337649845_GEN,
  map (fun j->if (j=0) then `#4.0` else `square (#2.3)`) (binexpand i 4)));;

let [I_6337649845_0;I_6337649845_1;I_6337649845_2;I_6337649845_3;
     I_6337649845_4;I_6337649845_5;I_6337649845_6;I_6337649845_7;
     I_6337649845_8;I_6337649845_9;I_6337649845_10;I_6337649845_11;
     I_6337649845_12;I_6337649845_13;I_6337649845_14;I_6337649845_15]=
 map mk_6337649845 (0 -- 15);;

let mk_6337649845r i=
  all_forall (list_mk_comb( I_6337649845_GEN2,
  map (fun j->if (j=0) then `#4.0` else `square (#2.3)`) (binexpand i 4)));;

let [I_6337649845_16;I_6337649845_17;I_6337649845_18;I_6337649845_19;
     I_6337649845_20;I_6337649845_21;I_6337649845_22;I_6337649845_23;
     I_6337649845_24;I_6337649845_25;I_6337649845_26;I_6337649845_27;
     I_6337649845_28;I_6337649845_29;I_6337649845_30;I_6337649845_31]=
 map mk_6337649845r (0 -- 15);;
...
all_forall `ineq
   [((#4.0),x1,(square (#2.3)));
    ...
    ((#4.0),x3,(square (#2.3)));
    ((#8.0),x4,(#8.0));
    ((square (#2.25)),x5,(square (#2.25)));
    ((square (#2.22)),x6,(square (#2.22)))
   ]
   (vor_0_x  x1 x2 x3 x4 x5 x6  < -- (#1.04) * pt - (#0.009))`;;

let I_6337649845_33=  (* -0.032 - 0.027 < -1.04 pt *)
all_forall `ineq
   [((#4.0),x1,(square (#2.3)));
    ((#4.0),x2,(square (#2.3)));
    ((#4.0),x3,(square (#2.3)));
   ...
   (vor_0_x  x1 x2 x3 x4 x5 x6  < -- (#0.032))`;;

let I_6337649845_34=  (* -0.032 - 0.027 < -1.04 pt *)
all_forall `ineq
   [((#4.0),x1,(square (#2.3)));
    ((#4.0),x2,(square (#2.3)));
    ((#4.0),x3,(square (#2.3)));
    ((#8.0),x4,(#8.0));
    ((square (#2.22)),x5,(square (#2.22)));
    ((#4.0),x6,(#4.0))
   ]
   (vor_0_x  x1 x2 x3 x4 x5 x6  < -- (#0.032))`;;
