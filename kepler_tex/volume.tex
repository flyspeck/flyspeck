...
\index{Index}{null set}\index{Index}{ZZZequiv@$\equiv$}
...
\begin{definition}[solid triangle] The solid triangle $ST(v_0,\{v_1,v_2,v_3\},r)$ is
...
\begin{definition}[circumradius, $\eta$]
...
\begin{definition}[$\dtet$, $\doct$]  Define 
  ...
  $$
for $a<b<c$.  
\index{Greek}{ZZdeltatet@$\dtet$}
\index{Greek}{ZZdeltaoct@$\doct$}
\index{Greek}{ZZdelta@$\delta$}
\end{definition}
...
%\begin{remark}\tlabel{remark:vor}\index{Index}{vor}\index{Index}{c-vor}\index{Index}{score}
...
\end{array}
$$
\index{Index}{fitted crown}\index{Index}{FC}\index{Index}{FCR}
...
Set
    ...
    \tlabel{eqn:4.5}
    \end{array}
    \end{equation}\index{Index}{anc@$\anc$}
...
Set
   ...
   \alpha\,\cro(y_1/2,t,\lambda)/(2\pi) +
    ...
    $$
    \index{Greek}{zzkappa@$\kappa(y_1,y_2,y_3,y_5,y_6,\alpha,t,\lambda)$}
    \index{Spec}{{\tt kappa\_dih\_h~y1~y2~y3~y5~y6~d}:\quad $\kappa(y_1,y_2,y_3,y_5,y_6,d,t_0,\lambda_{oct})$}
