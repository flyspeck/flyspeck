...
By Tarski arithmetic\tarf{enclosed-v}, an
...
Tarski arithmetic\tarf{pass-anchor}, $v_1$ and $v_2$ are anchors of
$\{v_0,w\}$. If $u$ is an anchor of $\{v_0,w\}$, then $\op{aff}_+^0(v_0,\{w,u\})$
does not meet $\op{aff}_+^0(v_0,\{v,v_i\})$ by
Tarski arithmetic\tarf{2t0-doesnt-pass-through}. 
...
so $S$ has type $\SA$. By Tarski arithmetic\tarf{277}, we have
...
\begin{proof}
By Tarski arithmetic\tarf{245}, there cannot be an enclosed vertex
of height at most $\sqrt2$. 
So nothing is enclosed over the flat quarter.
By Tarski arithmetic\tarf{245bis}, there cannot be an edge of length
...
\begin{proof}
Use Tarski arithmetic\tarf{2t0-doesnt-pass-through}.
\end{proof}
...
Tarski arithmetic\tarf{qrtet-over} shows that the interiors of
