...
an \newterm{exposed} surface area $\op{surf}(D_k(\u))$,   the area
...
node.  A convex node adjacent to the concave node has angle $>\pi/2$ because of dihedral angle estimates $\dih(2,2,2,3.2,3.2,2)>\pi/2$, and
...
nontriangular topological component of $Y(V,E_{ctc})$.  Thus, there
