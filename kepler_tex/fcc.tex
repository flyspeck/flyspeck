...
The \newterm{Voronoi cell} of a point $v$ in a packing $V$ is defined as the set of all
points in $\ring{R}^3$ 
...
arrangement.  We call it the \newterm{FCC pattern}.  Likewise, in the
HCP, each ball is tangent to twelve others in
the same arrangement  (Figure~\ref{fig:hcp}).  We call it the \newterm{HCP pattern}.  The FCC
...
From the non-existence of a counterexample $W$, 
...
\newterm{Marchal cells}.  The exact rules for the construction of Marchal cells
