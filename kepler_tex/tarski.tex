...
\begin{lemma}\guid{FHFMKIY}\rating{60}
...
\begin{lemma}\guid{POLFLZY}\rating{80}
Let $v_1,\ldots,v_4$ be four points
in $\ring{R}^3$.  Let $x_{ij} = |v_i-v_j|^2$.
...
%{Lemma 1.9}
\FIXX{I'm not sure the second part gets used.  Deleting it would simplify the proof.}
...
\begin{lemma}\guid{AAGNQFL}\rating{60}
