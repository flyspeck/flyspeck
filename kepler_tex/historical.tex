...
traced to T. Hariot (or Harriot).\index{Names}{Hariot, Thomas.}  
...
Pascal introduced the triangle. See Figure~\ref{fig:pascal}.\index{Names}{Pascal}  Each entry in the triangle represents the packing obtained
...
Rogers's bound.
\index{Names}{Muder, D.}\index{Names}{Rogers, C. A.}
...
until 1998 \cite{McL98}.\index{Names}{Fejes T\'oth, L.} One of the
...
central ball.\index{Names}{Boerdijk}
