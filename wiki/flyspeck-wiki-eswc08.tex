...
Starting from requirements how collaborating on the Kepler proof should be supported, we
have conducted a pre-study in a general-purpose semantic wiki in order to see what
possibilities this technology can offer Flyspeck.  Based on the results of this study, we
present domain-specific technologies developed in our group and establish a work plan for
tailoring a semantic wiki to the Flyspeck project.
