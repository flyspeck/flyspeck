...
loss of generality that $\|v-u_1'\|\ge 2.51$ or $\|v-u_2\|\ge 2.51$.   We may add inequality
$$
\|u_2\|\le 2.23,
$$
for otherwise by geometric considerations $\|u_2-u_1'\|> 3.2$.
We may stretch along the edges $\{u_2,u_1\}$, $\{u_2,u_1'\}$, moving $u_1,u_1'$, 
until $\|u_2-u_1\|=\|u_2-u_1'\|=3.2$.  We may scale $v,w$ until $\|v\|=\|w\|=2.51$.
Set $d(i,j) = \op{dih}(0,u_2,w_i,w_j)$.
Then interval arithmetic calculations\footnote{7431506800, XX} give the contradiction:
$$
