...
\label{fig:costa}
\end{figure}
% http://www.math.kobe-u.ac.jp/DIVERSIONS/g1costa.jpg 
% PERM. pending.
...
%  (Marc Leuwen, computational aspects).
...
$n=140,894,092,055,857,794$~\cite{Stanley}.
% Stanley example:
...
bookkeeping, one for rewriting, one for forward reasoning, one for
backward reasoning, and one for case
...
first-order theorem provers. Experiments have demonstrated that
...
% Computer languages that limit mathematical expression are unnecessarily restrictive!
...
I thank Adams (both Jeff and Mark), Urban, Carette, and Harrison for conversations
