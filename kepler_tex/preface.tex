...
Nevertheless, the proof involves many calculation that are routine and
yet sometimes long and tedious.  The proof relies on computer
calculations.  An error in any calculation or a bug in the computer
code has the potential of toppling the entire proof.
...
key to a simpler proof.''  I never produced a simpler correction.
C. Marchal did~\cite{unknown}.  His construction of a much simpler
function has become the key to the simpler proof presented in this
...
Because of the complexity of the solution to this problem, it is
particularly important for the reader to maintain a clear view of the
structure and organization of this book.


The introductory essays describe the major ideas, methods, and
organization of the proof.  There is an essay on each major computer
...
The fourth chapter covers fans, which gives planar graphs from a more
...
% I thank John Harrison for creating the most beautiful piece of
% software known to mankind.  I thank Mark Adams for showing me how a
% large-scale project should be organized and managed, and then for
% organizing and managing the Flyspeck project.

%\xfootnote{J. Harrison has contributed large bodies of formal
%mathematics to the libraries of the HOL Light theorem prover in
%order to make the Flyspeck project possible.}
