...
\begin{oldpart}{Use this idea somehow}
  In \product{Wikipedia} and \product{PlanetMath}, formulæ are given in presentational
  ...
  but any kind of (higher-order) logic required for specific domains\ednote{@Florian: This
    is quite superficial, can we write it in a more sophisticated way?} and employ
