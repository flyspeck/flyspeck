...
\begin{lemma} Let $P$ be a bounded polyhedron with $0$ as an interior pont.  Let $(V_P,E_P)$ be the associated fan.  There is a bijection between $E_P$ and the edges of $P$ given by 
$$
\{v,w\}\mapsto \op{conv}\{v,w\}.
$$
\end{lemma}
