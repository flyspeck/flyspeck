...
\begin{definition}[affine~set,~affine~hull,~affine~dimension]\label{def:affine}
...
\end{displaymath}
Recall that
the \newterm{affine hull} of $P\subset\ring{R}^n$ is the smallest affine set
