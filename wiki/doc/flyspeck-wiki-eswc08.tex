...
implemented, though.  Searching for arbitrary RDF triples is not yet supported by the user
interface, but authors can embed inline SPARQL queries into wiki pages.  Pages and
non-OMDoc links can be annotated with types from ontologies loaded into the
