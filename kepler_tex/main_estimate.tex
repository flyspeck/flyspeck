...
\begin{lemma}\guid{JBQGDOI}\label{lemma:nonagon}  
...
\begin{lemma}\guid{UZWGGKY}  Let $(\Lambda,v_0)$ be a centered packing with upright
...
\begin{lemma}\guid{XODSQWV}  Let $(\Lambda,v_0)$ be a centred packing.  
...
\begin{lemma}\guid{NTNOQVU}\tlabel{lemma:anchor-no-overlap}
...
\begin{lemma}\guid{SZTFKUR}  When there is an upright system diagonal with context
...
\begin{lemma}\guid{HHTUYOA} \label{lemma:s9-t9}
...
\begin{lemma}\guid{HWZUUGQ}\tlabel{lemma:1.47}
...
\begin{lemma}\guid{HJDOLHI}\dcg{Lemma~14.6}{165}\label{lemma:excess-1}
...
\begin{lemma}\guid{OOEVRVN}\label{prop:nonempty} 
