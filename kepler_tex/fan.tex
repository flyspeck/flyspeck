...
\begin{lemma}\guid{DWFBRQY}\rating{ZZ} 
...
\begin{definition}[nonconformant fan]
...
The property \case{bijection} of fans with conforming faces  holds for any non conformant fan:
...
\begin{lemma}\guid{TXFBALB}\rating{ZZ}  Let $(V,E)$ be any non conformant fan.  Then it has property \case{solid angle} of fans with conforming faces.
\end{lemma}
...
\begin{lemma}\guid{GGZWYRM}\rating{ZZ}  Let $(V,E)$ be any non conformant fan.  For any dart $x$ on any face $F$ and dart $z\in F$ that is not adjacent to $x$ under the face map, 
$$
...
\begin{lemma}\guid{HYUAZSE}\rating{ZZ}   Let $(V,E)$ be a non conformant fan.  Then  property \case{half-space} of fans with conforming faces holds for $(V,E)$.
\end{lemma}
\indy{Index}{component!topological}%
...
%Let $(V,E)$ be any non conformant fan.  Then a triangulation of $(V,E)$ exists.
%\end{lemma}
%
