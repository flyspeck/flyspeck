...
(* ------------------------------------------------------------------------- *)
  ...
  let the_type_constants = ref ["bool",0; "fun",2;"bigint",0]
...
(* ------------------------------------------------------------------------- *)
  ...
  let is_bigint = function (Bigint _) -> true | _ -> false
...
(* ------------------------------------------------------------------------- *)
  ...
  let dest_bigint =
    function (Bigint x) -> x | _ -> failwith "dest_bigint: not a bigint"
...
(* ------------------------------------------------------------------------- *)
  ...
  let rec orda env tm1 tm2 =
    ...
    | Bigint x1, Bigint x2 -> Pervasives.compare tm1 tm2
