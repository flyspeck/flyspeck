...
stated properties will be assumed without proof. \xfootnote{J. Harrison has already implemented gauge integration, which is much
...
\begin{definition}[wedge]\guid{NIQRVNM}
Assume that $\v_0\ne \v_1$ and that
...
\begin{definition}[lune]\guid{MVIADQK}
...
\begin{definition}[orthosimplex]\guid{LBDNNHE}\label{def:orth}  Let
...
%
%\begin{definition}[orth]\guid{ADEVNXQ}
% \tlabel{def:orth} Let
...
%\end{definition}
%
%%\begin{definition}[orthosimplex, orth]\guid{PQKOAPJ}
% \tlabel{def:ortho}
...
%\begin{definition}[circumradius, $\eta$]\guid{ZRFYJEF}\label{def:etaV}
...
%\end{definition}
%
%\begin{definition}[$abc$ parameter]\guid{FKZPELP}\tlabel{def:abc}
