...
There\footnote{XX: recheck proof} does not exist a set $S=\{0,v,w,u_1,u_2,u_1',u_2'\}$ of seven distinct points
...
An interval calculation\footnote{\calc{8167927350}} now gives the contradiction
...
$|u_1-u_2|>3.2$, unless $\|w\|\le 2.36$, $\|u_2\|\le 2.16$, $\|w-u_2\|\le 2.17$.  An interval calculation\footnote{\calc{6040218010}}
shows that
