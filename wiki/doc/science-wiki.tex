...
\begin{wrapfigure}{r}{4.2cm}
  ...
  \vspace{-.9cm}
  \begin{tikzpicture}
    \node (s) at (0,0) {\includegraphics[width=4cm]{creativity-spiral}};
...
Williams~\cite{wikinomics} will hold or can be satisfied by software support:\ednote{This
  is now more sound. --CL} The object of production is (immaterial) information, which
keeps the cost of participation low, we show how to break tasks down into small
pieces\ednote{Check whether we actually show this in this paper! --CL} that can be worked
