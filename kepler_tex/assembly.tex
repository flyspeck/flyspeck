...
By Tarski arithmetic\tarf{E:part4:2}, we have $|v-v_0|>2.6$.
If $|v_1-v_2|\le 2.1$,  or $|v_1-v_3|\le 2.1$, then
Tarski arithmetic\tarf{E:part4:3} gives $|v-v_0|>2.72$, 
...
$\op{conv}\{v_0,v,v_2\}$.
To establish (1) assume that $|v_2-v_0|\ge 2.2$.  Tarski arithmetic\tarf{last:E} 
gives
    $$|v_1-v_3|>2.6.$$
The bound $0.0063$ comes from
    $$\xikG + 2\xiV < -0.0063$$

To establish (2) assume that $|v_2-v_0|\le 2.2$. Tarski arithmetic\tarf{last:E} gives
    $$|v_1-v_3|>2.7.$$
  If the simplex
...
be two flat quarters because then Tarski arithmetic\tarf{E:part4:5} gives
$$|v_{12}-v_0|>2t_0.$$
...
$\{v_0,v_1,v_2,v_5\}$ because this and Tarski arithmetic\tarf{E:part4:6}\tarf{E:part4:7} would lead to a contradiction
$y_{12}>2t_0$. 
...
quarters because then Tarski arithmetic\tarf{E:part4:8}\tarf{E:part4:9} would imply $|v_{12}-v_0|>2t_0$.
...
\begin{proof}
    This fact is proved by Tarski arithmetic\tarf{2t0-doesnt-pass-through}.
\end{proof}
