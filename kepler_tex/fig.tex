...
% - Tikz.gen_out() now causes a stack overflow (in ML but not with HOL-Light loaded).
...
The disks have radius $2/\sqrt{3}$.
...
when $x$ is fixed by the permuation $f$.  The vertical
