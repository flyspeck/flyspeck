...
contour path.  M\"obius contours turn out to be extremely useful because in practice, the best way to certify that a given hypermap is nonplanar
...
$L_1$ is connected to a true face by the contour path $[x;n^{-1} x]$ because $n^{-1} x$ lies in the same face as $n f x$, which is a true
...
of $\Omega$.  The dart set of an $(\Omega,d)$-hypermap is a
subset of $\Omega$, and $d$ is the maximum cardinality of a face.  A
...
%
%
%\begin{proof} Let $H$ be a restricted hypermap with a  dart set that belongs
%  to $D$ and  greatest face cardinality is $d$.  It has a subquotient
...
%\end{proof}
%
%\begin{proof} Let $H$ be a restricted hypermap RR dart set belongs
%to $D$ and RR greatest face cardinality is $d$.  It has a subquotient
...
% normal family of Example~\ref{ex:H2} with two contour loops, RR
...
%  finite set $D$, and RR greatest face cardinality is $d$.
%\end{lemma}
