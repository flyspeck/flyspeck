...
As a first step, we syntactically separated definitions and lemmas in
the Twelf file by starting lemma identifiers with the string
``lemma-''.  During the import of new symbol $x$, the upload extension
recognizes all previously imported
symbols $y$ in the definition of the new symbol and 
creates links between $x,y$ in the wiki.
