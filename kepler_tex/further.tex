...
\begin{definition}[$D_3$]
  ...
  $\omega(\bu)$ at a distance of $1.3$ from $ \u_0$.  Let
\[
...
an \newterm{exposed} surface area $\op{surf}(D_k(\u))$.  This is the area
...
a distance of $2$ from twelve other points a \newterm{packing with full
...
\]
have a distance of at least $3.2$ from $\v$.  It follows that a half-disk
...
a distance of at least $2\hm$ from every other node of $V'$, and that it
has a distance of exactly $2\hm$ from at least two other nodes of $V'$.  In
