...
\begin{lemma}  Suppose that $V$ is a saturated packing with leaves $\bu$ and $\bu'$ and
signs $\sig$ and $\sig'$.  
...
\begin{lemma}  Let $V$ be a saturated packing with distinct leaves $\bu$, $\bv$ with $d_2\bu=d_2\bv$.
