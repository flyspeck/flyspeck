...
% XX http://www.careercast.com/jobs-rated/10-best-jobs-2011

% http://money.cnn.com/magazines/moneymag/bestjobs/2010/snapshots/1.html

%  In TV and film, the mathematician is the quirky
%character who writes formulas on mirrors and window panes to add extra
%flavor to a screenplay.


% LogAnswer http://www.uni-koblenz.de/~bpelzer/publications/FGHP08_IJCAR08_prel.pdf
% http://en.wikipedia.org/wiki/Netflix_Prize

% Gower's has initiated the ``colony of ants'' model of problem solving: focus thousands of mathematical eyeballs on the same blogged problem and hope for the best.
